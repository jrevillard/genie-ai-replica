  ...
  <Teleport to="body">
    <Transition name="dialog">
      ...
      >
        ...
        >
          <header v-if="title || description" class="border-b border-slate-100 px-6 py-4">
          ...
          <footer v-if="$slots.footer" class="flex items-center justify-end gap-2 border-t border-slate-100 px-6 py-4">
            <slot name="footer" />
          </footer>
        </div>
      </div>
