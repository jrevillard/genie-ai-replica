...
export default {
  ...
  charts: {
    ...
    cropHealthTitle: 'Kesehatan Tanaman - Indeks NDVI',
    cropHealthSubtitle: 'Kesehatan vegetasi per departemen',
    averageNDVI: 'NDVI Rata-rata',
    improving: 'Membaik',
    stable: 'Stabil',
    declining: 'Menurun',
    ...
    ndvi: 'NDVI',
    ndviValue: 'Nilai NDVI',
    allDepartments: 'Semua Departemen',
    pestAlertTitle: 'Peringatan Hama',
    pestAlertSubtitle: 'Peringatan hama dan penyakit saat ini',
    noPestAlerts: 'Tidak Ada Peringatan Hama Aktif',
    noPestAlertsDesc: 'Tidak ada peringatan hama untuk tingkat keparahan yang dipilih.',
    ...
    affectedCrops: 'Tanaman Terdampak',
    areas: 'Area Terdampak',
    firstDetected: 'Pertama Terdeteksi',
    viewMap: 'Lihat di Peta',
    share: 'Bagikan',
    getAssistance: 'Dapatkan Bantuan',
    assistancePrompt: 'Konteks peringatan hama siap. Tambahkan situasi spesifik Anda:',
    assistanceInstructions: 'Tambahkan konteks spesifik Anda di bawah ini:',
    assistanceHint: 'Ukuran tanaman, perawatan saat ini, pertanyaan spesifik...',
    submitQuery: 'Dapatkan Respons AI',
    ...
    source: 'Sumber',
    sharedVia: 'Dibagikan via',
    details: 'Detail',
    pestAlerts: 'Peringatan Hama',
    noLocationData: 'Data lokasi tidak tersedia',
    mapError: 'Tidak dapat membuka peta',
    ...
    market: {
      ...
      livestock: 'Ternak',
      fertilizer: 'Pupuk',
      apiary: 'Apikultur & Madu',
      aquaculture: 'Akuakultur',
      harvestStorage: 'Panen & Penyimpanan',
      trendUp: 'Naik',
      trendDown: 'Turun',
      trendStable: 'Stabil',
      trendUnknown: 'Tidak diketahui',
      latest: 'Terbaru',
      trend: 'Tren',
      ...
      predictionFor: 'Prediksi untuk',
      selectTimeFrame: 'Pilih Jangka Waktu Prediksi',
      timeFrame3Months: '3 bulan',
      timeFrame6Months: '6 bulan',
      timeFrame1Year: '1 tahun',
      timeFrame2Years: '2 tahun',
      worldNewsFactors: 'Faktor Berita Dunia (Opsional)',
      worldNewsHint: 'Mis., masalah rantai pasok global, kebijakan perdagangan, dll.',
      localNewsFactors: 'Faktor Berita El Salvador (Opsional)',
      localNewsHint: 'Mis., regulasi lokal, peristiwa cuaca, kebijakan, dll.',
      analyzing: 'Menganalisis data pasar...',
      error: 'Kesalahan',
      predictionsFor: 'Prediksi AI',
      noResponse: 'Tidak ada respons diterima',
      errorOccurred: 'Terjadi kesalahan',
      responseCopied: 'Respons disalin ke papan klip',
      copy: 'Salin',
      close: 'Tutup',
      share: 'Bagikan',
      shareViaEmail: 'Email',
      sharedVia: 'Dibagikan via AgroGenio AI',
      shareError: 'Gagal membagikan'
    },
    tooltip: {
      title: 'Tanggal',
