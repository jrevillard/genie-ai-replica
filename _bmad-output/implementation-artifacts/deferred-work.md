...
### DW-266a: Deleted requirements.in header documented the `uv pip compile` invocation used to regenerate the lock — that operational knowledge is lost with the file.
