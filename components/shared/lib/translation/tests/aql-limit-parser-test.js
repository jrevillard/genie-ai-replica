...
const getLimitStatementTests = () => [
  ...
  },
  {
    ...
    expected: [
      ...
      },
      {
        ...
        criteria: [
          {
            expression: { type: 'MemberExpression', object: { type: 'Identifier', name: 'a' }, property: 'timestamp' },
            direction: 'DESC'
          }
        ]
      },
  ...
  },
  {
    ...
    expected: [
      { type: 'ForStatement', variableName: 'u', collectionName: 'users' },
      {
        ...
        condition: {
          ...
          left: {
            type: 'FunctionCall',
            functionName: 'LOWER',
            args: [{ type: 'MemberExpression', object: { type: 'Identifier', name: 'u' }, property: 'loginName' }]
          },
      ...
      {
        type: 'LimitStatement',
        offset: { type: 'Identifier', name: '@offset' },
        count: { type: 'Identifier', name: '@limit' }
      }
    ]
  },
  {
      ...
      },
      {
        ...
        condition: {
          ...
          left: {
            ...
            object: { type: 'Identifier', name: 'conversation' },
            property: 'isArchived'
          },
    ...
    expected: [
      ...
      },
      {
        ...
        condition: {
          type: 'BinaryOperation',
          operator: '>',
          left: { type: 'FunctionCall', functionName: 'LENGTH', args: [{ type: 'Identifier', name: 'score' }] },
      ...
      },
      {
        ...
        criteria: [
          {
            expression: { type: 'FunctionCall', functionName: 'LENGTH', args: [{ type: 'Identifier', name: 'score' }] },
            direction: 'DESC'
          },
          {
      ...
      { type: 'ForStatement', variableName: 'q', collectionName: 'queries' },
      {
        ...
        condition: {
          ...
          right: {
            ...
            left: {
              type: 'MemberExpression',
              object: { type: 'MemberExpression', object: { type: 'Identifier', name: 'q' }, property: 'metadata' },
              property: 'isSaved'
            },
    ...
    expected: [
      ...
      },
      {
        ...
        expression: {
          ...
          functionName: 'UNION',
          args: [
            { type: 'Identifier', name: 'categorySimilar' },
            { type: 'Identifier', name: 'serviceSimilar' }
          ]
        }
      },
      ...
      {
        type: 'SortStatement',
        criteria: [{ expression: { type: 'FunctionCall', functionName: 'RAND', args: [] }, direction: 'ASC' }]
      },
      { type: 'LimitStatement', offset: 0, count: { type: 'Identifier', name: '@limit' } }
    ]
  },
        ...
        criteria: [
          {
            expression: {
              type: 'MemberExpression',
              object: { type: 'Identifier', name: 'session' },
              property: 'startTime'
            },
            direction: 'DESC'
          }
