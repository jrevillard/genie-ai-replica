...
export default {
  ...
  charts: {
    ...
    cropHealthTitle: 'Pflanzengesundheit - NDVI-Index',
    cropHealthSubtitle: 'Vegetationsgesundheit nach Departement',
    averageNDVI: 'Durchschnitts-NDVI',
    ...
    warning: 'Warnung',
    unknown: 'Unbekannt',
    byDepartment: 'Nach Departement',
    departments: 'Departemente',
    lastUpdated: 'Zuletzt aktualisiert',
    ndvi: 'NDVI',
    ndviValue: 'NDVI-Wert',
    allDepartments: 'Alle Departemente',
    pestAlertTitle: 'Schädlingswarnungen',
    pestAlertSubtitle: 'Aktuelle Schädlings- und Krankheitswarnungen',
    noPestAlerts: 'Keine aktiven Schädlingswarnungen',
    noPestAlertsDesc: 'Keine Schädlingswarnungen für die ausgewählte Schweregradstufe.',
    ...
    affectedCrops: 'Betroffene Kulturen',
    areas: 'Betroffene Gebiete',
    firstDetected: 'Erstmals erkannt',
    viewMap: 'Auf Karte anzeigen',
    share: 'Teilen',
    getAssistance: 'Hilfe erhalten',
    assistancePrompt: 'Der Schädlingswarnungskontext ist bereit. Fügen Sie Ihre spezifische Situation hinzu:',
    assistanceInstructions: 'Fügen Sie unten Ihren spezifischen Kontext hinzu:',
    assistanceHint: 'Anbaugebiet, aktuelle Behandlung, spezifische Fragen...',
    submitQuery: 'KI-Antwort erhalten',
    ...
    source: 'Quelle',
    sharedVia: 'Geteilt über',
    details: 'Details',
    pestAlerts: 'Schädlingswarnungen',
    noLocationData: 'Keine Standortdaten verfügbar',
    mapError: 'Karten konnten nicht geöffnet werden',
    ...
    market: {
      ...
      livestock: 'Vieh',
      fertilizer: 'Dünger',
      apiary: 'Imkerei & Honig',
      aquaculture: 'Aquakultur',
      harvestStorage: 'Ernte & Lagerung',
      trendUp: 'Steigend',
      trendDown: 'Fallend',
      trendStable: 'Stabil',
      trendUnknown: 'Unbekannt',
      latest: 'Aktuell',
      trend: 'Trend',
      ...
      predictionFor: 'Vorhersage für',
      selectTimeFrame: 'Vorhersagezeitraum auswählen',
      timeFrame3Months: '3 Monate',
      timeFrame6Months: '6 Monate',
      timeFrame1Year: '1 Jahr',
      timeFrame2Years: '2 Jahre',
      worldNewsFactors: 'Weltnachrichten-Faktoren (optional)',
      worldNewsHint: 'Z. B. globale Lieferkettenprobleme, Handelspolitiken usw.',
      localNewsFactors: 'El-Salvador-Nachrichtenfaktoren (optional)',
      localNewsHint: 'Z. B. lokale Vorschriften, Wetterereignisse, Richtlinien usw.',
      analyzing: 'Marktdaten werden analysiert...',
      error: 'Fehler',
      predictionsFor: 'KI-Vorhersagen',
      noResponse: 'Keine Antwort erhalten',
      errorOccurred: 'Ein Fehler ist aufgetreten',
      responseCopied: 'Antwort in die Zwischenablage kopiert',
      copy: 'Kopieren',
      close: 'Schließen',
      share: 'Teilen',
      shareViaEmail: 'E-Mail',
      sharedVia: 'Geteilt über AgroGenio AI',
      shareError: 'Fehler beim Teilen'
    },
    tooltip: {
      title: 'Datum',
  ...
  chatbot: {
    ...
    chatUpdated: 'Chat aktualisiert',
    feedbackError: 'Fehler beim Senden des Feedbacks',
    feedbackMissingQueryId: 'Abfrage-ID für Feedback fehlt',
    feedbackSubmitted: 'Feedback gesendet',
    saving: 'Speichern...',
    savingConversation: 'Konversation speichern...'
  },
  quickhelp: {
    // Labels (Short for UI)
