...
struct EnLocale {
  ...
  "sidebar": [
    ...
    "noServices": "No knowledge areas available",
    "noServiceResults": "No knowledge areas found for \"{term}\"",
    "errorLoadingServices": "Failed to load knowledge areas. Please try again.",
