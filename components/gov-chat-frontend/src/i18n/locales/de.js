...
export default {
  ...
  quickhelp: {
    ...
    applyForIDPrompt:
      'Ich möchte herausfinden, wie ich einen nationalen Personalausweis beantrage.',

    payTaxesPrompt:
      'Wie ist der Prozess, um meine Steuern online zu zahlen?',

    startBusinessPrompt:
      'Führen Sie mich durch die Schritte zur Registrierung eines neuen Unternehmens.',

    findHealthcarePrompt:
      'Wo finde ich Informationen über öffentliche Gesundheitsdienste?',

    educationServicesPrompt:
      'Welche Bildungsdienste stehen meinen Kindern zur Verfügung?',

    transportLicensesPrompt:
      'Wie erneuere ich meinen Führerschein?',

    housingProgramsPrompt:
      'Erzählen Sie mir von erschwinglichen Wohnungsprogrammen in Kenia.',

    findJobsPrompt:
      'Welche staatlichen Arbeitsmöglichkeiten gibt es derzeit?',

    justChatPrompt:
      'Ich möchte über Regierungsdienste chatten'
  },
  common: {
    cancel: 'Abbrechen',
    create: 'Erstellen',
