...
const Map<String, dynamic> arLocale = {
  ...
  "quickhelp": {
    ...
    "justChat": "مجرد دردشة",
    "justChatPrompt": "أود التحدث عن الخدمات الحكومية في كينيا",
    "applyForIDPrompt":
        "أحتاج إلى معلومات حول كيفية التقدم بطلب للحصول على بطاقة الهوية الوطنية في كينيا",
    "payTaxesPrompt": "ما هي إجراءات دفع الضرائب عبر الإنترنت في كينيا؟",
    "startBusinessPrompt": "أرشدني عبر خطوات تسجيل نشاط تجاري جديد في كينيا",
    "findHealthcarePrompt":
        "أين يمكنني العثور على معلومات حول خدمات الرعاية الصحية العامة في كينيا؟",
    "educationServicesPrompt":
        "ما هي الخدمات التعليمية المتاحة لأطفالي في كينيا؟",
    "transportLicensesPrompt":
        "كيف يمكنني تجديد رخصة القيادة الخاصة بي في كينيا؟",
    "housingProgramsPrompt": "أخبرني عن برامج الإسكان الميسر في كينيا",
    "findJobsPrompt": "ما هي الوظائف الحكومية المتاحة حالياً في كينيا؟",
  },
  "common": {
    "cancel": "إلغاء",
    "create": "إنشاء",
