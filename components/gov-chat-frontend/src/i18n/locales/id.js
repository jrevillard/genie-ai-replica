...
export default {
  ...
  quickhelp: {
    ...
    applyForIDPrompt:
      'Saya butuh informasi cara mengajukan KTP',

    payTaxesPrompt:
      'Bagaimana proses membayar pajak saya secara online?',

    startBusinessPrompt:
      'Bimbing saya melalui langkah-langkah untuk mendaftarkan bisnis baru',

    findHealthcarePrompt:
      'Di mana saya bisa mencari informasi tentang layanan kesehatan masyarakat?',

    educationServicesPrompt:
      'Layanan pendidikan apa yang tersedia untuk anak-anak saya?',

    transportLicensesPrompt:
      'Bagaimana cara memperpanjang SIM saya?',

    housingProgramsPrompt:
      'Beri tahu saya tentang program perumahan terjangkau di Kenya',

    findJobsPrompt:
      'Peluang kerja pemerintah apa yang saat ini tersedia?',

    justChatPrompt:
      'Saya ingin mengobrol tentang layanan pemerintah'
  },
  common: {
    cancel: 'Batal',
    create: 'Buat',
