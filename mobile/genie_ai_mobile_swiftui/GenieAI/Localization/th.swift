...
struct ThLocale {
  ...
  "sidebar": [
    ...
    "noServices": "ไม่มีพื้นที่ความรู้ที่พร้อมใช้งาน",
    "noServiceResults": "ไม่พบพื้นที่ความรู้สำหรับ \"{term}\"",
    "errorLoadingServices": "ไม่สามารถโหลดพื้นที่ความรู้ได้ กรุณาลองอีกครั้ง",
