...
const Map<String, dynamic> ruLocale = {
  ...
  "quickhelp": {
    ...
    "payTaxes": "Заплатить налоги",
    "startBusiness": "Начать бизнес",
    "findHealthcare": "Найти медицину",
    ...
    "justChat": "Просто пообщаться",
    "justChatPrompt": "Я хотел бы поговорить о государственных услугах в Кении",
    "applyForIDPrompt":
        "Мне нужна информация о том, как подать заявление на получение национального удостоверения личности в Кении",
    "payTaxesPrompt": "Каков процесс уплаты налогов онлайн в Кении?",
    "startBusinessPrompt":
        "Расскажите мне о шагах по регистрации нового бизнеса в Кении",
    "findHealthcarePrompt":
        "Где я могу найти информацию о государственных медицинских услугах в Кении?",
    "educationServicesPrompt":
        "Какие образовательные услуги доступны для моих детей в Кении?",
    "transportLicensesPrompt": "Как мне продлить водительские права в Кении?",
    "housingProgramsPrompt":
        "Расскажите мне о программах доступного жилья в Кении",
    "findJobsPrompt":
        "Какие государственные вакансии доступны в настоящее время в Кении?"
  },
  "common": {
    "cancel": "Отмена",
    "create": "Создать",
