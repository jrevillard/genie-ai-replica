...
class ChatHistoryService {
  ...
  async createConversationFromQuery(queryId, userId, options = {}) {
    try {
      ...
      const response = await httpService.post(`/chat/query/${queryId}/conversation`, { ...options, userId })
      return response.data
    } catch (error) {
  ...
  async addConversationToFolder(folderId, conversationId, userId) {
    try {
      ...
      const response = await httpService.post(`/chat/folders/${folderId}/conversations/${conversationId}`, { userId })
  ...
  async getFolderUsers(folderId, userId) {
    try {
      ...
      const response = await httpService.get(`/chat/folders/${folderId}/users`, { params: { userId } })
