...
export default {
  ...
  admin: {
    ...
    tools: {
      ...
      navFeeds: 'RSS-ленты',
      navWebSearch: 'Веб-поиск (SearXNG)',
      backToAdmin: 'Вернуться в админ-панель',
      pageTitle: 'Управление инструментами',
      feedsCardTitle: 'Ленты RSS-ингестора потоков',
      addFeed: '+ Добавить ленту',
      loadingFeeds: 'Загрузка лент...',
      tableFeedTitle: 'Название ленты',
      tableUrl: 'URL',
      tableInterval: 'Интервал (с)',
      tableStatus: 'Статус',
      tableFailures: 'Сбои',
      tableActions: 'Действия',
      noFeeds: 'Ленты не настроены.',
      statusActive: 'Активна',
      statusDisabled: 'Отключена',
      searxngCardTitle: 'Интеграция веб-поиска SearXNG',
      searxngDescription:
        'SearXNG интегрирован напрямую через службу поиска серверной части. Настройте параметры поиска, чтобы проверить соединение.',
      testSearchQuery: 'Тестовый запрос',
      searchPlaceholder: 'Введите запрос...',
      searching: 'Поиск...',
      testSearch: 'Тестовый поиск',
      results: 'Результаты',
      tableTitle: 'Название',
      tableEngine: 'Поисковик',
      editFeedTitle: 'Изменить ленту',
      addFeedTitle: 'Добавить новую ленту',
      formTitle: 'Название',
      formRssUrl: 'RSS-ссылка',
      formInterval: 'Интервал опроса (секунды)',
      formEnabled: 'Включена',
      cancel: 'Отмена',
      saveFeed: 'Сохранить ленту',
      deleteConfirm: 'Вы уверены, что хотите удалить эту ленту?',
      titlePlaceholder: 'напр. Новости ООН',
      navConfig: 'Конфигурация',
      configTitle: 'Конфигурация инструментов',
      loadingConfig: 'Загрузка конфигурации...',
      webSearchEnabled: 'Веб-поиск включён',
      webSearchHint: 'Вступает в силу со следующего запроса — без передислокации.',
      whitelistTitle: 'Белый список доменов (по одному в строке)',
      whitelistPlaceholder: 'who.int\nun.org',
      whitelistHint: 'Разрешённый домен охватывает все поддомены. Пусто = без фильтрации.',
      whitelistInvalid: 'Недопустимый домен: {d}',
      saving: 'Сохранение...',
      save: 'Сохранить',
      navAudit: 'Журнал аудита',
      auditTitle: 'Журнал аудита вызовов инструментов',
      auditExportCsv: 'Экспорт CSV',
      auditExportJson: 'Экспорт JSON',
      auditFilterTool: 'ID инструмента',
      auditFilterAction: 'Действие (invoke, block...)',
      auditFilterUser: 'ID пользователя',
      auditApply: 'Применить',
      auditLoading: 'Загрузка записей аудита...',
      auditColTime: 'Время',
      auditColTool: 'Инструмент',
      auditColAction: 'Действие',
      auditColDecision: 'Решение',
      auditColDuration: 'Длительность (мс)',
      auditColPii: 'Найдено PII',
      auditColUser: 'Пользователь',
      auditEmpty: 'Записей аудита пока нет — они появятся, когда система управления начнёт обработку вызовов.',
      auditMore: 'Загрузить ещё',
      navHealth: 'Состояние',
      healthTitle: 'Обзор состояния',
      healthRefresh: 'Обновить',
      healthLoading: 'Загрузка обзора состояния...',
      healthTools: 'Инструменты',
      healthFeeds: 'Ленты',
      healthColTool: 'Инструмент',
      healthColCircuit: 'Предохранитель',
      healthColReachable: 'Доступен',
      healthColError: 'Ошибка',
      healthColFeed: 'Лента',
      healthColStatus: 'Статус',
      healthColFailures: 'Сбои',
      healthColLastPoll: 'Последний опрос',
      healthNoFeeds: 'Ленты не настроены.',
      healthYes: 'Да',
      healthNo: 'Нет'
    },
    huduma: 'Genie AI',
