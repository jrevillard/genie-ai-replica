...
export default {
  ...
  charts: {
    ...
    fastActions: '快速操作',
    cropHealth: '作物健康',
    cropHealthTitle: '作物健康 - NDVI 指数',
    cropHealthSubtitle: '各地区的植被健康',
    averageNDVI: '平均 NDVI',
    improving: '改善中',
    stable: '稳定',
    declining: '下降中',
    ...
    ndviValue: 'NDVI 值',
    allDepartments: '所有部门',
    pestAlertTitle: '病虫害警报',
    pestAlertSubtitle: '当前病虫害警告',
    noPestAlerts: '无活跃病虫害警报',
    noPestAlertsDesc: '所选严重级别无病虫害警报。',
    activeAlerts: '活跃警报',
    active: '活跃',
    all: '全部',
    high: '高',
    ...
    share: '分享',
    getAssistance: '获取帮助',
    assistancePrompt: '病虫害警报上下文已就绪。请添加您的具体情况：',
    assistanceInstructions: '请在下方添加您的具体上下文：',
    assistanceHint: '作物规模、当前处理、具体问题……',
    submitQuery: '获取 AI 回复',
    aiResponse: 'AI 回复',
    noResponse: '无回复',
    errorOccurred: '发生错误',
    ...
    market: {
      ...
      year: '年',
      value: '值',
      getPredictions: '获取 AI 预测',
      predictionFor: '预测',
      selectTimeFrame: '选择预测时间范围',
      timeFrame3Months: '3 个月',
      timeFrame6Months: '6 个月',
      timeFrame1Year: '1 年',
      timeFrame2Years: '2 年',
      worldNewsFactors: '世界新闻因素（可选）',
      worldNewsHint: '例如，全球供应链问题、贸易政策等',
      localNewsFactors: '萨尔瓦多新闻因素（可选）',
      localNewsHint: '例如，当地法规、天气事件、政策等',
      analyzing: '正在分析市场数据……',
      error: '错误',
      predictionsFor: 'AI 预测',
      noResponse: '未收到回复',
      errorOccurred: '发生错误',
      responseCopied: '回复已复制到剪贴板',
      copy: '复制',
      close: '关闭',
      share: '分享',
      shareViaEmail: '电子邮件',
      sharedVia: '通过 AgroGenio AI 分享',
      shareError: '分享出错'
    },
    tooltip: {
      title: '日期',
