...
class ArangoDBDataprepRequest(DataprepRequest):
    def __init__(
        ...
        # Temporarily remove until labelling system logic is defined
    ):
        super().__init__(
            files=files,
            link_list=link_list,
        ...
        # self.file_labels = file_labels ############## Temporarily remove until labelling sysem logic is defined
...
class ArangoDBDataprepRequestFromDocRepo(ArangoDBDataprepRequest):
    def __init__(
        ...
        storage_path: Optional[str] = None, # Real path where the file is saved
        file_path: Optional[str] = None, # temporary path used when getting file content
