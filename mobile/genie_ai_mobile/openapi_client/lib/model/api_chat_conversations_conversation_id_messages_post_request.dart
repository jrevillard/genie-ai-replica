...
/// Sender of the message
enum ApiChatConversationsConversationIdMessagesPostRequestSenderEnum {
  user._(r'user'),
  assistant._(r'assistant'),
  ;

  /// Instantiate a new enum with the provided value.
  const ApiChatConversationsConversationIdMessagesPostRequestSenderEnum._(this._value);
  ...
  /// Returns the instance of [ApiChatConversationsConversationIdMessagesPostRequestSenderEnum] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [ApiChatConversationsConversationIdMessagesPostRequestSenderEnum]
...
class ApiChatConversationsConversationIdMessagesPostRequestSenderEnumTypeTransformer {
  ...
  String encode(ApiChatConversationsConversationIdMessagesPostRequestSenderEnum data) => data._value;
  ...
  ApiChatConversationsConversationIdMessagesPostRequestSenderEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is ApiChatConversationsConversationIdMessagesPostRequestSenderEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
