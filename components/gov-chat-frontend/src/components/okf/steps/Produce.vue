  ...
  <div class="okf-step">
    ...
    <div class="okf-step__progress">
      <DsProgress
        ...
        :indeterminate="true"
        :show-label="true"
        :label="translate('okf.steps.produce.progress', 'Producer running...')"
      />
    </div>
    <p class="okf-step__placeholder">
      {{
        translate(
          'okf.steps.produce.placeholder',
          'Phase 6 wires this to the producer service; for now this step is a placeholder.'
        )
      }}
    </p>
  </div>
