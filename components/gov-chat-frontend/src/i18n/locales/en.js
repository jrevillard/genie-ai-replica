...
export default {
  ...
  admin: {
    ...
    tools: {
      ...
      navFeeds: 'RSS Feeds',
      navWebSearch: 'Web Search (SearXNG)',
      backToAdmin: 'Back to Admin',
      pageTitle: 'Tools Management',
      feedsCardTitle: 'RSS Stream Ingestor Feeds',
      addFeed: '+ Add Feed',
      loadingFeeds: 'Loading feeds...',
      tableFeedTitle: 'Feed Title',
      tableUrl: 'URL',
      tableInterval: 'Interval (s)',
      tableStatus: 'Status',
      ...
      searxngCardTitle: 'SearXNG Web Search Integration',
      searxngDescription:
      ...
      addFeedTitle: 'Add New Feed',
      formTitle: 'Title',
      formRssUrl: 'RSS URL',
      formInterval: 'Polling Interval (seconds)',
      formEnabled: 'Enabled',
      cancel: 'Cancel',
      saveFeed: 'Save Feed',
      deleteConfirm: 'Are you sure you want to delete this feed?',
      titlePlaceholder: 'e.g. UN News',
      navConfig: 'Configuration',
      configTitle: 'Tools Configuration',
      loadingConfig: 'Loading configuration...',
      webSearchEnabled: 'Web search enabled',
      webSearchHint: 'Takes effect on the next query — no redeployment needed.',
      whitelistTitle: 'Domain whitelist (one per line)',
      whitelistPlaceholder: 'who.int\nun.org',
      whitelistHint: 'A whitelisted domain covers all its subdomains. Empty = no filtering.',
      whitelistInvalid: 'Invalid domain: {d}',
      saving: 'Saving...',
      save: 'Save',
      navAudit: 'Audit Log',
      auditTitle: 'Tool Invocation Audit Log',
      auditExportCsv: 'Export CSV',
      auditExportJson: 'Export JSON',
      auditFilterTool: 'Tool ID',
      auditFilterAction: 'Action (invoke, block...)',
      auditFilterUser: 'User ID',
      auditApply: 'Apply',
      ...
      auditColDuration: 'Duration (ms)',
      auditColPii: 'PII found',
      auditColUser: 'User',
      auditEmpty: 'No audit entries yet — entries appear once tool governance is processing invocations.',
      auditMore: 'Load more',
      navHealth: 'Health',
      healthTitle: 'Health Overview',
      healthRefresh: 'Refresh',
      healthLoading: 'Loading health overview...',
      healthTools: 'Tools',
      healthFeeds: 'Feeds',
      healthColTool: 'Tool',
      healthColCircuit: 'Circuit',
      healthColReachable: 'Reachable',
      healthColError: 'Error',
      healthColFeed: 'Feed',
      healthColStatus: 'Status',
      healthColFailures: 'Failures',
      healthColLastPoll: 'Last polled',
      healthNoFeeds: 'No feeds configured.',
      healthYes: 'Yes',
      healthNo: 'No'
    },
    huduma: 'Genie AI',
