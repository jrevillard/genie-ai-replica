...
class OpeaArangoRetriever(OpeaComponent):
    ...
    async def invoke(
        ...
        dimension = len(embedding) # The use of embedding (from random_doc) should only be getting the dimension :| But later in similarity search, it is used as the query embedding. :|
