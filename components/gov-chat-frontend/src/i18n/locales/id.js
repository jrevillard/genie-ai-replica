...
export default {
  ...
  admin: {
    ...
    tools: {
      ...
      navigation: 'NAVIGASI',
      navFeeds: 'Umpan RSS',
      navWebSearch: 'Pencarian web (SearXNG)',
      backToAdmin: 'Kembali ke Admin',
      pageTitle: 'Manajemen alat',
      feedsCardTitle: 'Umpan ingestor aliran RSS',
      addFeed: '+ Tambah umpan',
      loadingFeeds: 'Memuat umpan...',
      tableFeedTitle: 'Judul umpan',
      tableUrl: 'URL',
      tableInterval: 'Interval (dtk)',
      tableStatus: 'Status',
      tableFailures: 'Kegagalan',
      tableActions: 'Tindakan',
      noFeeds: 'Belum ada umpan yang dikonfigurasi.',
      statusActive: 'Aktif',
      statusDisabled: 'Nonaktif',
      searxngCardTitle: 'Integrasi pencarian web SearXNG',
      searxngDescription:
        'SearXNG terintegrasi secara native melalui layanan pencarian backend. Konfigurasikan parameter pencarian untuk menguji konektivitas.',
      testSearchQuery: 'Kueri uji',
      searchPlaceholder: 'Masukkan kueri...',
      searching: 'Mencari...',
      testSearch: 'Uji pencarian',
      results: 'Hasil',
      tableTitle: 'Judul',
      tableEngine: 'Mesin',
      editFeedTitle: 'Edit umpan',
      addFeedTitle: 'Tambah umpan baru',
      formTitle: 'Judul',
      formRssUrl: 'URL RSS',
      formInterval: 'Interval polling (detik)',
      formEnabled: 'Diaktifkan',
      cancel: 'Batal',
      saveFeed: 'Simpan umpan',
      deleteConfirm: 'Yakin ingin menghapus umpan ini?',
      titlePlaceholder: 'mis. Berita PBB',
      navConfig: 'Konfigurasi',
      configTitle: 'Konfigurasi alat',
      loadingConfig: 'Memuat konfigurasi...',
      webSearchEnabled: 'Pencarian web diaktifkan',
      webSearchHint: 'Berlaku pada kueri berikutnya — tanpa redeploy.',
      whitelistTitle: 'Daftar putih domain (satu per baris)',
      whitelistPlaceholder: 'who.int\nun.org',
      whitelistHint: 'Domain yang diizinkan mencakup semua subdomainnya. Kosong = tanpa filter.',
      whitelistInvalid: 'Domain tidak valid: {d}',
      saving: 'Menyimpan...',
      save: 'Simpan',
      navAudit: 'Log audit',
      auditTitle: 'Log audit pemanggilan alat',
      auditExportCsv: 'Ekspor CSV',
      auditExportJson: 'Ekspor JSON',
      auditFilterTool: 'ID alat',
      auditFilterAction: 'Aksi (invoke, block...)',
      auditFilterUser: 'ID pengguna',
      auditApply: 'Terapkan',
      auditLoading: 'Memuat entri audit...',
      auditColTime: 'Waktu',
      auditColTool: 'Alat',
      auditColAction: 'Aksi',
      auditColDecision: 'Keputusan',
      auditColDuration: 'Durasi (ms)',
      auditColPii: 'PII ditemukan',
      auditColUser: 'Pengguna',
      auditEmpty: 'Belum ada entri audit — muncul setelah tata kelola memproses pemanggilan.',
      auditMore: 'Muat lagi',
      navHealth: 'Kesehatan',
      healthTitle: 'Ringkasan kesehatan',
      healthRefresh: 'Segarkan',
      healthLoading: 'Memuat ringkasan kesehatan...',
      healthTools: 'Alat',
      healthFeeds: 'Umpan',
      healthColTool: 'Alat',
      healthColCircuit: 'Pemutus',
      healthColReachable: 'Dapat dijangkau',
      healthColError: 'Kesalahan',
      healthColFeed: 'Umpan',
      healthColStatus: 'Status',
      healthColFailures: 'Kegagalan',
      healthColLastPoll: 'Polling terakhir',
      healthNoFeeds: 'Belum ada umpan yang dikonfigurasi.',
      healthYes: 'Ya',
      healthNo: 'Tidak'
    },
    huduma: 'Genie AI',
