...
<template>
  <div class="okf-step">
    ...
    <p class="okf-step__hint">{{ translate('okf.steps.entry.hint', 'Give this OKF repository a clear name and pick its subject area.') }}</p>
    <div class="okf-step__fields">
      <DsFormGroup :label="translate('okf.steps.entry.nameLabel', 'Repository name')" input-id="okf-entry-name">
        <DsInput id="okf-entry-name" v-model="local.name" :placeholder="translate('okf.steps.entry.namePh', 'e.g. Transport permits NL')" />
      </DsFormGroup>
...
.okf-step__fields { display: grid; grid-template-columns: 1fr 1fr; gap: var(--space-md); }
</style>
