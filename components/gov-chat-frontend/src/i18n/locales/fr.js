...
export default {
  ...
  "chatbot": {
    "serviceLabelMismatch": "Le service « {label} » utilise une étiquette d'interface qui peut ne pas correspondre à la hiérarchie de connaissances",
    ...
    "configMismatchWarning": "Incohérence de configuration : {warnings}. Vérifiez la configuration de l'Aide rapide et la hiérarchie de connaissances.",
