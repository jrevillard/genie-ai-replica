...
export default {
  ...
  admin: {
    ...
    tools: {
      ...
      navigation: '导航',
      navFeeds: 'RSS 订阅源',
      navWebSearch: '网页搜索（SearXNG）',
      backToAdmin: '返回管理后台',
      pageTitle: '工具管理',
      feedsCardTitle: 'RSS 流式采集器订阅源',
      addFeed: '+ 添加订阅源',
      loadingFeeds: '正在加载订阅源...',
      tableFeedTitle: '订阅源标题',
      tableUrl: 'URL',
      tableInterval: '间隔（秒）',
      tableStatus: '状态',
      tableFailures: '失败次数',
      ...
      statusActive: '启用',
      statusDisabled: '停用',
      searxngCardTitle: 'SearXNG 网页搜索集成',
      searxngDescription: 'SearXNG 已通过后端搜索服务原生集成。配置搜索参数以测试连通性。',
      testSearchQuery: '测试搜索查询',
      ...
      titlePlaceholder: '例如：联合国新闻',
      navConfig: '配置',
      configTitle: '工具配置',
      loadingConfig: '正在加载配置...',
      webSearchEnabled: '网页搜索已启用',
      webSearchHint: '下一次查询即生效——无需重新部署。',
      whitelistTitle: '域名白名单（每行一个）',
      whitelistPlaceholder: 'who.int\nun.org',
      whitelistHint: '白名单域名涵盖其所有子域名。留空 = 不过滤。',
      whitelistInvalid: '无效域名：{d}',
      saving: '保存中...',
      save: '保存',
      navAudit: '审计日志',
      auditTitle: '工具调用审计日志',
      ...
      auditFilterTool: '工具 ID',
      auditFilterAction: '操作（invoke、block...）',
      auditFilterUser: '用户 ID',
      auditApply: '应用',
      auditLoading: '正在加载审计条目...',
      auditColTime: '时间',
      auditColTool: '工具',
      auditColAction: '操作',
      auditColDecision: '决定',
      auditColDuration: '时长（毫秒）',
      auditColPii: '发现 PII',
      auditColUser: '用户',
      auditEmpty: '暂无审计条目——工具治理开始处理调用后会出现。',
      auditMore: '加载更多',
      navHealth: '健康状态',
      healthTitle: '健康概览',
      healthRefresh: '刷新',
      healthLoading: '正在加载健康概览...',
      healthTools: '工具',
      healthFeeds: '订阅源',
      healthColTool: '工具',
      healthColCircuit: '熔断器',
      healthColReachable: '可达',
      healthColError: '错误',
      healthColFeed: '订阅源',
      healthColStatus: '状态',
      healthColFailures: '失败次数',
      healthColLastPoll: '上次轮询',
      healthNoFeeds: '尚未配置任何订阅源。',
      healthYes: '是',
      healthNo: '否'
    },
    huduma: 'Genie AI',
