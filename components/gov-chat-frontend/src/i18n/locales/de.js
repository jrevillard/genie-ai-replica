...
export default {
  ...
  admin: {
    ...
    tools: {
      ...
      navFeeds: 'RSS-Feeds',
      navWebSearch: 'Websuche (SearXNG)',
      backToAdmin: 'Zurück zur Verwaltung',
      pageTitle: 'Tool-Verwaltung',
      feedsCardTitle: 'Feeds des RSS-Stream-Ingestors',
      addFeed: '+ Feed hinzufügen',
      loadingFeeds: 'Feeds werden geladen...',
      tableFeedTitle: 'Feed-Titel',
      tableUrl: 'URL',
      tableInterval: 'Intervall (s)',
      tableStatus: 'Status',
      tableFailures: 'Fehler',
      tableActions: 'Aktionen',
      noFeeds: 'Keine Feeds konfiguriert.',
      statusActive: 'Aktiv',
      statusDisabled: 'Deaktiviert',
      searxngCardTitle: 'SearXNG-Websuche-Integration',
      searxngDescription:
        'SearXNG ist nativ über den Suchdienst des Backends integriert. Konfigurieren Sie Suchparameter, um die Konnektivität zu testen.',
      testSearchQuery: 'Testsuchanfrage',
      searchPlaceholder: 'Anfrage eingeben...',
      searching: 'Suche läuft...',
      testSearch: 'Testsuche',
      results: 'Ergebnisse',
      tableTitle: 'Titel',
      tableEngine: 'Suchmaschine',
      editFeedTitle: 'Feed bearbeiten',
      addFeedTitle: 'Neuen Feed hinzufügen',
      formTitle: 'Titel',
      formRssUrl: 'RSS-URL',
      formInterval: 'Abrufintervall (Sekunden)',
      formEnabled: 'Aktiviert',
      cancel: 'Abbrechen',
      saveFeed: 'Feed speichern',
      deleteConfirm: 'Möchten Sie diesen Feed wirklich löschen?',
      titlePlaceholder: 'z. B. UN-Nachrichten',
      navConfig: 'Konfiguration',
      configTitle: 'Werkzeugkonfiguration',
      loadingConfig: 'Konfiguration wird geladen...',
      webSearchEnabled: 'Websuche aktiviert',
      webSearchHint: 'Wirkt bei der nächsten Abfrage — ohne Neubereitstellung.',
      whitelistTitle: 'Domänenausschlussliste (eine pro Zeile)',
      whitelistPlaceholder: 'who.int\nun.org',
      whitelistHint: 'Eine erlaubte Domäne deckt alle Subdomänen ab. Leer = keine Filterung.',
      whitelistInvalid: 'Ungültige Domäne: {d}',
      saving: 'Speichern...',
      save: 'Speichern',
      navAudit: 'Audit-Log',
      auditTitle: 'Werkzeug-Aufruf-Auditlog',
      auditExportCsv: 'CSV exportieren',
      auditExportJson: 'JSON exportieren',
      auditFilterTool: 'Werkzeug-ID',
      auditFilterAction: 'Aktion (invoke, block...)',
      auditFilterUser: 'Benutzer-ID',
      auditApply: 'Anwenden',
      auditLoading: 'Audit-Einträge werden geladen...',
      auditColTime: 'Zeit',
      auditColTool: 'Werkzeug',
      auditColAction: 'Aktion',
      auditColDecision: 'Entscheidung',
      auditColDuration: 'Dauer (ms)',
      auditColPii: 'PII gefunden',
      auditColUser: 'Benutzer',
      auditEmpty: 'Noch keine Audit-Einträge — sie erscheinen, sobald Governance Aufrufe verarbeitet.',
      auditMore: 'Mehr laden',
      navHealth: 'Status',
      healthTitle: 'Statusübersicht',
      healthRefresh: 'Aktualisieren',
      healthLoading: 'Statusübersicht wird geladen...',
      healthTools: 'Werkzeuge',
      healthFeeds: 'Feeds',
      healthColTool: 'Werkzeug',
      healthColCircuit: 'Schalter',
      healthColReachable: 'Erreichbar',
      healthColError: 'Fehler',
      healthColFeed: 'Feed',
      healthColStatus: 'Status',
      healthColFailures: 'Fehler',
      healthColLastPoll: 'Letzter Abruf',
      healthNoFeeds: 'Keine Feeds konfiguriert.',
      healthYes: 'Ja',
      healthNo: 'Nein'
    },
    huduma: 'Genie AI',
