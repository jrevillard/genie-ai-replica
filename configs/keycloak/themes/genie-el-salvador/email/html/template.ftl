...
<head>
    ...
    <title>${subject!"AgroGenio AI"}</title>
</head>
    ...
    <tr>
        <td align="center" style="padding:24px 0;">
            <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;background-color:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.05);">
                <tr>
                    <td style="background:linear-gradient(135deg,#0073AA 0%,#2E7D32 100%);padding:24px;text-align:center;">
                        <img src="cid:logo.png" alt="AgroGenio AI" style="display:block;max-width:120px;max-height:40px;">
                        <div style="color:#ffffff;font-size:20px;font-weight:600;margin-top:8px;">AgroGenio AI</div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="background-color:#f8fafc;padding:20px 32px;text-align:center;border-top:1px solid #cbd5e1;">
                        <p style="margin:0;font-weight:600;color:#475569;">Gobierno de El Salvador</p>
                        <p style="margin:0;color:#475569;">AgroGenio AI — Asistente Agrícola Inteligente</p>
                        <p style="margin:8px 0 0 0;color:#888888;font-size:12px;line-height:1.5;">This email was sent by AgroGenio AI. Please do not reply to this email.</p>
                    </td>
                </tr>
            </table>
        </td>
