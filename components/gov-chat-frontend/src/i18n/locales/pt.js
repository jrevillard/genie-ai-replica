...
export default {
  ...
  "chatbot": {
    ...
    "configMismatchWarning": "Incompatibilidade de configuração: {warnings}. Verifique a configuração de Ajuda Rápida e hierarquia de conhecimento.",
    "categoryNotFound": "Categoria \"{label}\" não encontrada na hierarquia de conhecimento",
    "serviceLabelMismatch": "Serviço \"{label}\" usa um rótulo de UI que pode não corresponder à hierarquia de conhecimento",
