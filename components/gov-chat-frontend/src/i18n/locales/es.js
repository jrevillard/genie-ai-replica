...
export default {
  ...
  "chatbot": {
    ...
    "configMismatchWarning": "Incoherencia de configuración: {warnings}. Verifique la configuración de Ayuda Rápida y la jerarquía de conocimiento.",
    "categoryNotFound": "Categoría \"{label}\" no encontrada en la jerarquía de conocimiento",
    "serviceLabelMismatch": "Servicio \"{label}\" utiliza una etiqueta de UI que puede no coincidir con la jerarquía de conocimiento",
