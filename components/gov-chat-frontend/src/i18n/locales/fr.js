...
export default {
  ...
  charts: {
    ...
    cropHealthTitle: 'Santé des cultures - Indice NDVI',
    cropHealthSubtitle: 'Santé de la végétation par département',
    ...
    pestAlertTitle: 'Alertes de ravageurs',
    pestAlertSubtitle: 'Avertissements actuels de ravageurs et de maladies',
    noPestAlerts: 'Aucune alerte de ravageur active',
    noPestAlertsDesc: 'Aucune alerte de ravageur pour le niveau de gravité sélectionné.',
    ...
    affectedCrops: 'Cultures affectées',
    areas: 'Zones affectées',
    firstDetected: 'Première détection',
    viewMap: 'Voir sur la carte',
    share: 'Partager',
    getAssistance: "Obtenir de l'assistance",
    assistancePrompt: "Le contexte de l'alerte de ravageur est prêt. Ajoutez votre situation spécifique :",
    assistanceInstructions: 'Ajoutez votre contexte spécifique ci-dessous :',
    assistanceHint: 'Taille de culture, traitement actuel, questions spécifiques...',
    submitQuery: 'Obtenir une réponse IA',
    ...
    details: 'Détails',
    pestAlerts: 'Alertes de ravageurs',
    ...
    market: {
      ...
      livestock: 'Bétail',
      fertilizer: 'Engrais',
      apiary: 'Apiculture et miel',
      aquaculture: 'Aquaculture',
      harvestStorage: 'Récolte et stockage',
      trendUp: 'En hausse',
      trendDown: 'En baisse',
      trendStable: 'Stable',
      trendUnknown: 'Inconnu',
      latest: 'Dernier',
      trend: 'Tendance',
      ...
      predictionFor: 'Prédiction pour',
      selectTimeFrame: 'Sélectionner la période de prédiction',
      timeFrame3Months: '3 mois',
      timeFrame6Months: '6 mois',
      timeFrame1Year: '1 an',
      timeFrame2Years: '2 ans',
      worldNewsFactors: 'Facteurs des actualités mondiales (facultatif)',
      worldNewsHint: "Ex. : problèmes de chaîne d'approvisionnement mondiale, politiques commerciales, etc.",
      localNewsFactors: 'Facteurs des actualités du Salvador (facultatif)',
      localNewsHint: 'Ex. : réglementations locales, événements climatiques, politiques, etc.',
      analyzing: 'Analyse des données du marché...',
      error: 'Erreur',
      predictionsFor: 'Prédictions IA',
      noResponse: 'Aucune réponse reçue',
      errorOccurred: "Une erreur s'est produite",
      responseCopied: 'Réponse copiée dans le presse-papiers',
      copy: 'Copier',
      close: 'Fermer',
      share: 'Partager',
      shareViaEmail: 'E-mail',
      sharedVia: 'Partagé via AgroGenio AI',
      shareError: 'Erreur lors du partage'
    },
    tooltip: {
      title: 'Date',
