...
export default {
  ...
  chatbot: {
    ...
    welcomeMessage: 'ยินดีต้อนรับ! ฉันจะช่วยคุณได้อย่างไรในวันนี้?',
    attachFile: 'แนบไฟล์',
  ...
  quickhelp: {
    ...
    applyForIDPrompt:
      'ฉันต้องการข้อมูลเกี่ยวกับวิธีสมัครบัตรประชาชนแห่งชาติ',

    payTaxesPrompt:
      'กระบวนการชำระภาษีออนไลน์คืออะไร?',

    startBusinessPrompt:
      'นำฉันผ่านขั้นตอนการจดทะเบียนธุรกิจใหม่',

    findHealthcarePrompt:
      'ฉันสามารถหาข้อมูลเกี่ยวกับบริการสุขภาพสาธารณะได้ที่ไหน?',

    educationServicesPrompt:
      'บริการการศึกษาอะไรที่มีสำหรับลูกของฉัน?',

    transportLicensesPrompt:
      'ฉันจะต่ออายุใบขับขี่อย่างไร?',

    housingProgramsPrompt:
      'บอกฉันเกี่ยวกับโปรแกรมที่อยู่อาศัยราคาไม่แพงในเคนยา',

    findJobsPrompt:
      'โอกาสงานรัฐบาลอะไรที่มีอยู่ในปัจจุบัน?',

    justChatPrompt:
      'ฉันอยากแชทเกี่ยวกับบริการรัฐบาล'
  },
  common: {
    cancel: 'ยกเลิก',
    create: 'สร้าง',
