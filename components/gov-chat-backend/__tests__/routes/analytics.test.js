...
describe("GET /api/analytics/dashboard (AC2)", () => {
  ...
  it("should return 200 with dashboard data when valid token provided", async () => {
    ...
    const response = await authGet(
      "/api/analytics/dashboard?startDate=2025-01-01&endDate=2025-01-31&locale=en",
    );
...
describe("GET /api/analytics/metric/:metric (AC3)", () => {
  it("should return 200 with { metric, value } for totalQueries", async () => {
    ...
    const response = await authGet(
      "/api/analytics/metric/totalQueries?startDate=2025-01-01&endDate=2025-01-31",
    );
  ...
  it("should return 200 with { metric, value } for uniqueUsers", async () => {
    ...
    const response = await authGet(
      "/api/analytics/metric/uniqueUsers?startDate=2025-01-01&endDate=2025-01-31",
    );
  ...
  it("should return 200 with { metric, value } for averageResponseTime", async () => {
    ...
    const response = await authGet(
      "/api/analytics/metric/averageResponseTime?startDate=2025-01-01&endDate=2025-01-31",
    );
  ...
  it("should return 200 with { metric, value } for satisfactionRate", async () => {
    ...
    const response = await authGet(
      "/api/analytics/metric/satisfactionRate?startDate=2025-01-01&endDate=2025-01-31",
    );
  ...
  it("should return 400 for unsupported metric name", async () => {
    const response = await authGet(
      "/api/analytics/metric/invalidMetric?startDate=2025-01-01&endDate=2025-01-31",
    );

    expect(response.status).toBe(400);
    expect(response.body).toEqual({
      error: "Unsupported metric: invalidMetric",
    });
  });
...
describe("GET /api/analytics (AC4)", () => {
  ...
  it("should return 200 with general analytics data", async () => {
    ...
    const response = await authGet(
      "/api/analytics?startDate=2025-01-01&endDate=2025-01-31",
    );
  ...
  it("should pass filters as parsed JSON when provided", async () => {
    ...
    const response = await authGet(
      `/api/analytics?filters=${encodeURIComponent(filters)}&locale=fr`,
    );
...
describe("GET /api/analytics/timeseries/:metricType (AC5)", () => {
  it("should return 200 with time series array for valid metricType and interval", async () => {
    ...
    expect(response.body).toEqual([
      {
        timestamp: "2025-01-01T00:00:00Z",
        dateLabel: "2025-01-01T00:00:00Z",
        value: 100,
        userCount: 50,
      },
      {
        timestamp: "2025-01-02T00:00:00Z",
        dateLabel: "2025-01-02T00:00:00Z",
        value: 120,
        userCount: 60,
      },
    ]);
    expect(analyticsService.getTimeSeriesData).toHaveBeenCalledWith(
      "queries",
      "daily",
      "2025-01-01",
      "2025-01-31",
  ...
  it("should return 400 for invalid interval", async () => {
    ...
    expect(response.body).toEqual({
      error:
        "Invalid interval: yearly. Must be one of: hourly, daily, weekly, monthly",
    });
  });
...
describe("GET /api/analytics/events (AC7)", () => {
  it("should return 200 with paginated results", async () => {
    const events = [
      { _key: "e-1", eventType: "pageView", timestamp: "2025-01-01T00:00:00Z" },
    ];
...
describe("GET /api/analytics/satisfaction/gauge (AC8)", () => {
  ...
  it("should return 200 with gauge data", async () => {
    ...
    const response = await authGet(
      "/api/analytics/satisfaction/gauge?startDate=2025-01-01&endDate=2025-01-31",
    );
...
describe("GET /api/analytics/satisfaction/heatmap (AC8)", () => {
  ...
  it("should return 200 with heatmap array", async () => {
    ...
    const response = await authGet(
      "/api/analytics/satisfaction/heatmap?startDate=2025-01-01&endDate=2025-01-31",
    );
