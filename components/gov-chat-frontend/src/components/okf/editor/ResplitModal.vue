<!--
  ...
  Confirms the destructive re-split (deletes all concepts + graph, re-imports
    ...
    <p class="okf-resplit__warn">
      {{
        translate(
          ...
          'This deletes all current concepts and the derived graph, then re-imports the source file with the new split. Concept edits are lost.'
        )
      }}
    </p>
