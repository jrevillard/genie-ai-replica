...
| `reranker_score_temperature` | `1.0` | Confidence: temperature for sigmoid calibration |
| `llm_self_confidence_enabled` | `0` | Confidence: opt-in LLM self-grade (`[[CONF:0-100]]` → `self_confidence`); off by default |
