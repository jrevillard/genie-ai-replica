...
class DatabaseService {
  ...
  _isConnectionError(error) {
    ...
    if (
      connectionErrorStrings.some(
        (errStr) => message.includes(errStr.toLowerCase()) || code.includes(errStr.toLowerCase())
      )
    ) {
