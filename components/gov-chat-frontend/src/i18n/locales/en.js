...
export default {
  ...
  quickhelp: {
    ...
    plantBasicGrainsUserPrompt: "I want step-by-step instructions on planting staple crops like corn, beans, rice, or sorghum.",
    diagnosePestDiseaseUserPrompt: "My crop or animal is sick, and I need immediate identification and treatment options.",
    growFruitsVeggiesUserPrompt: "I need cultivation guides for specific fruits or vegetables.",
    managePoultryPigsUserPrompt: "I need information on raising broiler chickens, laying hens, or pigs.",
    fertilizerSoilAdviceUserPrompt: "I need to know how to prepare my soil or what fertilizer formula to apply.",
    startManageApiaryUserPrompt: "I want to set up beehives, harvest honey, or treat bee diseases.",
    tilapiaPondCareUserPrompt: "I need to manage a fish pond, improve water quality, or farm tilapia.",
    harvestStorageUserPrompt: "I am ready to harvest and need to know how to store my yield to prevent loss.",
