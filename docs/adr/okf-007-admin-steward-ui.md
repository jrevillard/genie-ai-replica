...
- PRD §6.2, Open Question 7; SST Epic 4 (planned); Architecture §10 (authoring & curation tooling lanes — incl. the author-side local conformance validator/linter CLI).
