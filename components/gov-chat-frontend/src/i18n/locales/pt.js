...
export default {
  ...
  quickhelp: {
    ...
    applyForIDPrompt:
      'Preciso de informações sobre como solicitar um cartão de ID nacional',

    payTaxesPrompt:
      'Qual é o processo para pagar meus impostos online?',

    startBusinessPrompt:
      'Guie-me pelos passos para registrar um novo negócio',

    findHealthcarePrompt:
      'Onde posso encontrar informações sobre serviços de saúde pública?',

    educationServicesPrompt:
      'Quais serviços de educação estão disponíveis para meus filhos?',

    transportLicensesPrompt:
      'Como renovo minha carteira de motorista?',

    housingProgramsPrompt:
      'Conte-me sobre programas de habitação acessível no Quênia',

    findJobsPrompt:
      'Quais oportunidades de emprego governamental estão disponíveis atualmente?',

    justChatPrompt:
      'Gostaria de conversar sobre serviços governamentais'
  },
  common: {
    cancel: 'Cancelar',
    create: 'Criar',
