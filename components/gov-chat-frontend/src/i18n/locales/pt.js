...
export default {
  ...
  charts: {
    ...
    cropHealthTitle: 'Saúde das Culturas - Índice NDVI',
    cropHealthSubtitle: 'Saúde da vegetação por departamento',
    averageNDVI: 'NDVI Médio',
    ...
    pestAlertTitle: 'Alertas de Pragas',
    pestAlertSubtitle: 'Avisos atuais de pragas e doenças',
    noPestAlerts: 'Sem Alertas de Pragas Ativos',
    noPestAlertsDesc: 'Sem alertas de pragas para o nível de gravidade selecionado.',
    ...
    areas: 'Áreas Afetadas',
    firstDetected: 'Primeira Detecção',
    viewMap: 'Ver no Mapa',
    share: 'Compartilhar',
    getAssistance: 'Obter Assistência',
    assistancePrompt: 'O contexto do alerta de praga está pronto. Adicione sua situação específica:',
    assistanceInstructions: 'Adicione seu contexto específico abaixo:',
    assistanceHint: 'Tamanho da cultura, tratamento atual, perguntas específicas...',
    submitQuery: 'Obter Resposta da IA',
    ...
    noLocationData: 'Sem dados de localização disponíveis',
    mapError: 'Não foi possível abrir os mapas',
    ...
    market: {
      ...
      apiary: 'Apicultura e Mel',
      aquaculture: 'Aquicultura',
      harvestStorage: 'Colheita e Armazenamento',
      trendUp: 'Subindo',
      trendDown: 'Caindo',
      trendStable: 'Estável',
      trendUnknown: 'Desconhecido',
      latest: 'Mais recente',
      trend: 'Tendência',
      ...
      predictionFor: 'Previsão para',
      selectTimeFrame: 'Selecionar Período de Previsão',
      timeFrame3Months: '3 meses',
      timeFrame6Months: '6 meses',
      timeFrame1Year: '1 ano',
      timeFrame2Years: '2 anos',
      worldNewsFactors: 'Fatores de Notícias Mundiais (Opcional)',
      worldNewsHint: 'Ex., problemas da cadeia de suprimentos global, políticas comerciais, etc.',
      localNewsFactors: 'Fatores de Notícias de El Salvador (Opcional)',
      localNewsHint: 'Ex., regulamentações locais, eventos climáticos, políticas, etc.',
      analyzing: 'Analisando dados de mercado...',
      error: 'Erro',
      predictionsFor: 'Previsões da IA',
      noResponse: 'Nenhuma resposta recebida',
      errorOccurred: 'Ocorreu um erro',
      responseCopied: 'Resposta copiada para a área de transferência',
      copy: 'Copiar',
      close: 'Fechar',
      share: 'Compartilhar',
      shareViaEmail: 'E-mail',
      sharedVia: 'Compartilhado via AgroGenio AI',
      shareError: 'Erro ao compartilhar'
    },
    tooltip: {
      title: 'Data',
