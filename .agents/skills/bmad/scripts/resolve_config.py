...
def main() -> int:
    parser = argparse.ArgumentParser(description="Resolve BMad central config using four-layer TOML merge (project default, global user, project team, project user).")
    parser.add_argument(
        "--project-root",
        "-p",
        required=True,
