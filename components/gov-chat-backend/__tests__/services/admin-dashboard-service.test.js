...
describe("AdminDashboardService", () => {
  ...
  describe("getUserStats", () => {
    ...
    it("should throw when not initialized", async () => {
      adminDashboardService.db = null;
      await expect(adminDashboardService.getUserStats()).rejects.toThrow(
        "Database not initialized",
      );
    });
  });
  ...
  describe("searchUsers", () => {
    ...
    it("should throw when not initialized", async () => {
      adminDashboardService.db = null;
      await expect(adminDashboardService.searchUsers()).rejects.toThrow(
        "Database not initialized",
      );
    });
  });
  ...
  describe("rolloverLogs", () => {
    ...
    it("should re-throw non-ENOENT access errors", async () => {
      ...
      await expect(adminDashboardService.rolloverLogs()).rejects.toThrow(
        "Permission denied",
      );
    });
  });
  ...
  describe("runDiagnostics", () => {
    ...
    it("should handle DB health check failure in diagnostics", async () => {
      ...
      const result = await adminDashboardService.runDiagnostics();
      const dbCheck = result.networkChecks.find(
  ...
  describe("backupDatabase", () => {
    ...
    it("should throw when not initialized", async () => {
      adminDashboardService.db = null;
      await expect(adminDashboardService.backupDatabase()).rejects.toThrow(
        "Database not initialized",
      );
    });
  ...
  describe("optimizeDatabase", () => {
    ...
    it("should throw when not initialized", async () => {
      adminDashboardService.db = null;
      await expect(adminDashboardService.optimizeDatabase()).rejects.toThrow(
        "Database not initialized",
      );
    });
  });
  ...
  describe("storeAnalyticsData", () => {
    ...
    it("should handle errors silently", async () => {
      ...
      await expect(
        adminDashboardService.storeAnalyticsData({
          period: "daily",
  ...
  describe("formatTimeAgo", () => {
    ...
    it("should return N days ago", () => {
      ...
      expect(adminDashboardService.formatTimeAgo(fiveDaysAgo)).toBe(
        "5 days ago",
      );
    });
  });
  ...
  describe("getLogsSummary", () => {
    it("should delegate to logsService", async () => {
      const mockLogsService = {
        getLogsSummary: jest
          .fn()
          .mockResolvedValue({ errors: [], warnings: [], date: "2026-05-26" }),
      };
      adminDashboardService.setLogsService(mockLogsService);
      const result = await adminDashboardService.getLogsSummary({
        date: "2026-05-26",
      });
      expect(mockLogsService.getLogsSummary).toHaveBeenCalledWith({
        date: "2026-05-26",
      });
  ...
  describe("searchLogs", () => {
    it("should delegate to logsService", async () => {
      ...
      expect(mockLogsService.searchLogs).toHaveBeenCalledWith({
        term: "error",
      });
      expect(result.logs).toEqual([]);
    });
    ...
    it("should throw when logsService not set", async () => {
      await expect(adminDashboardService.searchLogs()).rejects.toThrow(
        "LogsService not initialized",
      );
    });
  ...
  describe("getSystemHealth", () => {
    ...
    it("should throw when not initialized", async () => {
      adminDashboardService.db = null;
      await expect(adminDashboardService.getSystemHealth()).rejects.toThrow(
        "Database not initialized",
      );
    });
