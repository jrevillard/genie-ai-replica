...
ARANGO_USE_APPROX_SEARCH = os.getenv("RETRIEVER_ARANGO_USE_APPROX_SEARCH", "false")
...
ARANGO_TRAVERSAL_ENABLED = os.getenv("RETRIEVER_ARANGO_TRAVERSAL_ENABLED", "false")
...
SUMMARIZER_ENABLED = os.getenv("RETRIEVER_SUMMARIZER_ENABLED", "false")
