...
export default {
  ...
  "chatbot": {
    ...
    "configMismatchWarning": "Konfigurationsfehler: {warnings}. Bitte überprüfen Sie die Schnellhilfe- und Wissenshierarchie-Konfiguration.",
    "categoryNotFound": "Kategorie \"{label}\" nicht in der Wissenshierarchie gefunden",
    "serviceLabelMismatch": "Dienst \"{label}\" verwendet ein UI-Label, das möglicherweise nicht zur Wissenshierarchie passt",
