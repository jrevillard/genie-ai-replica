...
For the complete system architecture diagrams (C4 Context, C4 Container, OIDC sequence, JWKS validation), see [Architecture Overview](/docs/architecture/architecture/).
