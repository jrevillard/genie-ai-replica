...
export default {
  ...
  quickhelp: {
    ...
    housingProgramsUserPrompt: 'Tell me about affordable housing programs available to me',
    findJobsUserPrompt: 'What government job opportunities are currently available?',

    // System Prompts (sent to LLM - mirror the visible text; no embedded
    // country-specific "facts" so the assistant relies entirely on the
    // configured knowledge base instead of inventing details from the prompt)
    ...
    housingProgramsPrompt: 'Tell me about affordable housing programs available to me',
