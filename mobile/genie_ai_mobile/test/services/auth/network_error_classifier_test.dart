...
void main() {
  ...
  group('NetworkErrorClassifier', () {
    group('isNetworkError', () {
      ...
      test('returns true for FlutterAppAuthPlatformException with network code', () {
      ...
      test('returns true for FlutterAppAuthPlatformException with connection code', () {
        final error = FlutterAppAuthPlatformException(
      ...
      test('returns true for FlutterAppAuthPlatformException with timeout code', () {
        final error = FlutterAppAuthPlatformException(
      ...
      test('returns true for FlutterAppAuthPlatformException with unreachable code', () {
        final error = FlutterAppAuthPlatformException(
      ...
      test('returns true for FlutterAppAuthPlatformException with no_browser code', () {
        final error = FlutterAppAuthPlatformException(
      ...
      test('returns false for FlutterAppAuthPlatformException with invalid_grant', () {
        final error = FlutterAppAuthPlatformException(
          code: 'invalid_grant',
      ...
      test('returns false for FlutterAppAuthPlatformException with invalid_client', () {
        final error = FlutterAppAuthPlatformException(
          code: 'invalid_client',
