...
export default {
  ...
  admin: {
    ...
    tools: {
      ...
      navigation: 'التنقل',
      navFeeds: 'خلاصات RSS',
      navWebSearch: 'البحث على الويب (SearXNG)',
      backToAdmin: 'العودة إلى لوحة الإدارة',
      pageTitle: 'إدارة الأدوات',
      feedsCardTitle: 'خلاصات مستورِد تدفقات RSS',
      addFeed: '+ إضافة خلاصة',
      loadingFeeds: 'جارٍ تحميل الخلاصات...',
      tableFeedTitle: 'عنوان الخلاصة',
      tableUrl: 'الرابط',
      tableInterval: 'الفاصل الزمني (ث)',
      tableStatus: 'الحالة',
      tableFailures: 'حالات الفشل',
      tableActions: 'الإجراءات',
      noFeeds: 'لا توجد خلاصات مُهيأة.',
      statusActive: 'نشطة',
      statusDisabled: 'معطّلة',
      searxngCardTitle: 'تكامل البحث على الويب SearXNG',
      searxngDescription:
        'SearXNG مدمج بشكل أصلي عبر خدمة البحث في الواجهة الخلفية. قم بتكوين معلمات البحث لاختبار الاتصال.',
      testSearchQuery: 'استعلام اختباري',
      searchPlaceholder: 'أدخل الاستعلام...',
      searching: 'جارٍ البحث...',
      testSearch: 'اختبار البحث',
      results: 'النتائج',
      tableTitle: 'العنوان',
      tableEngine: 'محرك البحث',
      editFeedTitle: 'تعديل الخلاصة',
      addFeedTitle: 'إضافة خلاصة جديدة',
      formTitle: 'العنوان',
      formRssUrl: 'رابط RSS',
      formInterval: 'فاصل الاستقصاء (ثوانٍ)',
      formEnabled: 'مُمكّنة',
      cancel: 'إلغاء',
      saveFeed: 'حفظ الخلاصة',
      deleteConfirm: 'هل أنت متأكد من أنك تريد حذف هذه الخلاصة؟',
      titlePlaceholder: 'مثال: أخبار الأمم المتحدة',
      navConfig: 'الإعدادات',
      configTitle: 'إعدادات الأدوات',
      loadingConfig: 'جارٍ تحميل الإعدادات...',
      webSearchEnabled: 'البحث على الويب مُمكّن',
      webSearchHint: 'يسريstarting من الاستعلام التالي — دون إعادة نشر.',
      whitelistTitle: 'قائمة النطاقات المسموح بها (واحد في كل سطر)',
      whitelistPlaceholder: 'who.int\nun.org',
      whitelistHint: 'النطاق المسموح يغطي جميع نطاقاته الفرعية. فارغ = بدون تصفية.',
      whitelistInvalid: 'نطاق غير صالح: {d}',
      saving: 'جارٍ الحفظ...',
      save: 'حفظ',
      navAudit: 'سجل التدقيق',
      auditTitle: 'سجل تدقيق استدعاءات الأدوات',
      auditExportCsv: 'تصدير CSV',
      auditExportJson: 'تصدير JSON',
      auditFilterTool: 'معرّف الأداة',
      auditFilterAction: 'الإجراء (invoke, block...)',
      auditFilterUser: 'معرّف المستخدم',
      auditApply: 'تطبيق',
      auditLoading: 'جارٍ تحميل مدخلات التدقيق...',
      auditColTime: 'الوقت',
      auditColTool: 'الأداة',
      auditColAction: 'الإجراء',
      auditColDecision: 'القرار',
      auditColDuration: 'المدة (م‌ث)',
      auditColPii: 'PII موجود',
      auditColUser: 'المستخدم',
      auditEmpty: 'لا توجد مدخلات تدقيق بعد — ستظهر عندما تبدأ الحوكمة بمعالجة الاستدعاءات.',
      auditMore: 'تحميل المزيد',
      navHealth: 'الحالة',
      healthTitle: 'نظرة عامة على الحالة',
      healthRefresh: 'تحديث',
      healthLoading: 'جارٍ تحميل نظرة الحالة...',
      healthTools: 'الأدوات',
      healthFeeds: 'الخلاصات',
      healthColTool: 'الأداة',
      healthColCircuit: 'قاطع الدائرة',
      healthColReachable: 'قابل للوصول',
      healthColError: 'خطأ',
      healthColFeed: 'الخلاصة',
      healthColStatus: 'الحالة',
      healthColFailures: 'حالات الفشل',
      healthColLastPoll: 'آخر استقصاء',
      healthNoFeeds: 'لا توجد خلاصات مُهيأة.',
      healthYes: 'نعم',
      healthNo: 'لا'
    },
    manage: 'إدارة',
