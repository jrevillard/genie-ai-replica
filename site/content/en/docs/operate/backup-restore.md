...
| Restore succeeds but the frontend shows the wrong language set | `KEYCLOAK_SUPPORTED_LOCALES` changed since the backup | Re-apply the env var to match the backed-up Keycloak realm config |
