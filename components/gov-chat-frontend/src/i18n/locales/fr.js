...
export default {
  ...
  admin: {
    ...
    tools: {
      ...
      navFeeds: 'Flux RSS',
      navWebSearch: 'Recherche web (SearXNG)',
      backToAdmin: "Retour à l'administration",
      pageTitle: 'Gestion des outils',
      feedsCardTitle: "Flux de l'ingesteur de flux RSS",
      addFeed: '+ Ajouter un flux',
      loadingFeeds: 'Chargement des flux...',
      tableFeedTitle: 'Titre du flux',
      tableUrl: 'URL',
      tableInterval: 'Intervalle (s)',
      tableStatus: 'État',
      tableFailures: 'Échecs',
      tableActions: 'Actions',
      noFeeds: 'Aucun flux configuré.',
      statusActive: 'Actif',
      statusDisabled: 'Désactivé',
      searxngCardTitle: 'Intégration de recherche web SearXNG',
      searxngDescription:
        'SearXNG est intégré nativement via le service de recherche du backend. Configurez les paramètres de recherche pour tester la connectivité.',
      testSearchQuery: 'Requête de test',
      searchPlaceholder: 'Saisissez la requête...',
      searching: 'Recherche...',
      testSearch: 'Tester la recherche',
      results: 'Résultats',
      tableTitle: 'Titre',
      tableEngine: 'Moteur',
      editFeedTitle: 'Modifier le flux',
      addFeedTitle: 'Ajouter un nouveau flux',
      formTitle: 'Titre',
      formRssUrl: 'URL RSS',
      formInterval: "Intervalle d'interrogation (secondes)",
      formEnabled: 'Activé',
      cancel: 'Annuler',
      saveFeed: 'Enregistrer le flux',
      deleteConfirm: 'Voulez-vous vraiment supprimer ce flux ?',
      titlePlaceholder: "ex. Actualités de l'ONU",
      navConfig: 'Configuration',
      configTitle: 'Configuration des outils',
      loadingConfig: 'Chargement de la configuration...',
      webSearchEnabled: 'Recherche web activée',
      webSearchHint: 'Prend effet à la prochaine requête — sans redéploiement.',
      whitelistTitle: 'Liste blanche de domaines (un par ligne)',
      whitelistPlaceholder: 'who.int\nun.org',
      whitelistHint: 'Un domaine autorisé couvre tous ses sous-domaines. Vide = aucun filtrage.',
      whitelistInvalid: 'Domaine non valide : {d}',
      saving: 'Enregistrement...',
      save: 'Enregistrer',
      navAudit: "Journal d'audit",
      auditTitle: "Journal d'audit des invocations",
      auditExportCsv: 'Exporter CSV',
      auditExportJson: 'Exporter JSON',
      auditFilterTool: "ID d'outil",
      auditFilterAction: 'Action (invoke, block...)',
      auditFilterUser: 'ID utilisateur',
      auditApply: 'Appliquer',
      auditLoading: "Chargement des entrées d'audit...",
      auditColTime: 'Heure',
      auditColTool: 'Outil',
      auditColAction: 'Action',
      auditColDecision: 'Décision',
      auditColDuration: 'Durée (ms)',
      auditColPii: 'PII détecté',
      auditColUser: 'Utilisateur',
      auditEmpty: "Aucune entrée d'audit pour le moment — elles apparaîtront une fois la gouvernance active.",
      auditMore: 'Charger plus',
      navHealth: 'Santé',
      healthTitle: "Aperçu de l'état",
      healthRefresh: 'Actualiser',
      healthLoading: "Chargement de l'état...",
      healthTools: 'Outils',
      healthFeeds: 'Flux',
      healthColTool: 'Outil',
      healthColCircuit: 'Disjoncteur',
      healthColReachable: 'Joignable',
      healthColError: 'Erreur',
      healthColFeed: 'Flux',
      healthColStatus: 'État',
      healthColFailures: 'Échecs',
      healthColLastPoll: 'Dernière interrogation',
      healthNoFeeds: 'Aucun flux configuré.',
      healthYes: 'Oui',
      healthNo: 'Non'
    },
    huduma: 'Genie AI',
