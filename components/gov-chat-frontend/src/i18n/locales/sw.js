...
export default {
  ...
  charts: {
    ...
    cropHealthTitle: 'Afya ya Mazao - Kiwango cha NDVI',
    cropHealthSubtitle: 'Afya ya mimea kwa idara',
    averageNDVI: 'Wastani wa NDVI',
    improving: 'Inaboreshwa',
    stable: 'Imara',
    declining: 'Inazorota',
    overallHealth: 'Afya kwa Ujumla',
    good: 'Nzuri',
    moderate: 'Wastani',
    warning: 'Onyo',
    unknown: 'Haijulikani',
    ...
    ndvi: 'NDVI',
    ndviValue: 'Thamani ya NDVI',
    allDepartments: 'Idara Zote',
    pestAlertTitle: 'Maonyo ya Wadudu',
    pestAlertSubtitle: 'Maonyo ya sasa ya wadudu na magonjwa',
    noPestAlerts: 'Hakuna Maonyo ya Wadudu Yaliyo Hai',
    noPestAlertsDesc: 'Hakuna maonyo ya wadudu kwa kiwango cha ukali kilichochaguliwa.',
    activeAlerts: 'Maonyo Hai',
    active: 'hai',
    all: 'Yote',
    high: 'Kubwa',
    low: 'Ndogo',
    recommendations: 'Mapendekezo',
    affectedCrops: 'Mazao Yaliyoathiriwa',
    areas: 'Maeneo Yaliyoathiriwa',
    firstDetected: 'Imegundulwa kwa Mar ya kwanza',
    viewMap: 'Tazama kwenye Ramani',
    share: 'Shiriki',
    getAssistance: 'Pata Msaada',
    assistancePrompt: 'Muktadha wa onyo la wadudu unapatikana. Ongeza hali yako mahususi:',
    assistanceInstructions: 'Ongeza muktadha wako mahususi hapa chini:',
    assistanceHint: 'Ukubwa wa zao, matibabu ya sasa, maswali mahususi...',
    submitQuery: 'Pata Jibu la AI',
    aiResponse: 'Jibu la AI',
    noResponse: 'Hakuna jibu',
    errorOccurred: 'Kosa limetokea',
    responseCopied: 'Jibu limekopwa',
    copy: 'Nakili',
    close: 'Funga',
    pest: 'Mdudu',
    description: 'Maelezo',
    source: 'Chanzo',
    sharedVia: 'Imeshirikiwa kupitia',
    details: 'Maelezo zaidi',
    pestAlerts: 'Maonyo ya Wadudu',
    noLocationData: 'Hakuna data ya eneo',
    ...
    market: {
      ...
      livestock: 'Mifugo',
      fertilizer: 'Mbolea',
      apiary: 'Ukalishi Nyuki na Asali',
      aquaculture: 'Uvuvi',
      harvestStorage: 'Uvunaji na Hifadhi',
      trendUp: 'Inaongezeka',
      trendDown: 'Inapungua',
      trendStable: 'Imara',
      trendUnknown: 'Haijulikani',
      ...
      year: 'Mwaka',
      value: 'Thamani',
      getPredictions: 'Pata Utabiri wa AI',
      predictionFor: 'Utabiri kwa',
      selectTimeFrame: 'Chagua Kipindi cha Utabiri',
      timeFrame3Months: 'Miezi 3',
      timeFrame6Months: 'Miezi 6',
      timeFrame1Year: 'Mwaka 1',
      timeFrame2Years: 'Miaka 2',
      worldNewsFactors: 'Mambo ya Habari za Dunia (Hiari)',
      worldNewsHint: 'Mf., matatizo ya mnyororo wa usambazaji wa kimataifa, sera za biashara, n.k.',
      localNewsFactors: 'Mambo ya Habari za El Salvador (Hiari)',
      localNewsHint: 'Mf., kanuni za ndani, matukio ya hali ya hewa, sera, n.k.',
      analyzing: 'Inachambua data ya soko...',
      error: 'Kosa',
      predictionsFor: 'Utabiri wa AI',
      noResponse: 'Hakuna jibu lililopokelewa',
      errorOccurred: 'Kosa limetokea',
      responseCopied: 'Jibu limekopwa kwenye clipboard',
      copy: 'Nakili',
      close: 'Funga',
      share: 'Shiriki',
      shareViaEmail: 'Barua pepe',
      sharedVia: 'Imeshirikiwa kupitia AgroGenio AI',
      shareError: 'Kosa kushiriki'
    },
    tooltip: {
      title: 'Tarehe',
