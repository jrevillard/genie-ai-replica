...
struct EsLocale {
  ...
  "sidebar": [
    ...
    "noServices": "No hay áreas de conocimiento disponibles",
    "noServiceResults": "No se encontraron áreas de conocimiento para \"{term}\"",
    "errorLoadingServices": "Error al cargar las áreas de conocimiento. Por favor, inténtelo de nuevo.",
