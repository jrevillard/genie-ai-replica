...
export default {
  ...
  quickhelp: {
    ...
    justChat: "Solo Chatear",
    justChatPrompt: "Me gustaría chatear sobre servicios gubernamentales",
    applyForIDPrompt: "Necesito información sobre cómo solicitar una tarjeta de ID nacional",
    payTaxesPrompt: "¿Cuál es el proceso para pagar mis impuestos en línea?",
    startBusinessPrompt: "Guíeme a través de los pasos para registrar un nuevo negocio",
    findHealthcarePrompt: "¿Dónde puedo encontrar información sobre servicios de salud pública?",
    educationServicesPrompt: "¿Qué servicios educativos están disponibles para mis hijos?",
    transportLicensesPrompt: "¿Cómo renuevo mi licencia de conducir?",
    housingProgramsPrompt: "Cuénteme sobre programas de vivienda asequible en Kenia",
    findJobsPrompt: "¿Qué oportunidades de empleo gubernamentales están disponibles actualmente?"
  },
  common: {
    cancel: 'Cancelar',
    create: 'Crear',
