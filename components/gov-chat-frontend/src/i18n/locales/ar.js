export default {
  ...
  okf: {
    ...
    graph: {
      ...
      building: 'جارٍ تجهيز الرسم البياني…',
      concepts: 'المفاهيم',
    ...
    import: {
      title: 'استيراد المستندات إلى مستودع OKF جديد',
      hint: 'تتحول المستندات إلى مستودع واحد — تُقسَّم وتربط وتُوسم معًا. لا يُنشر شيء؛ يتبع سير العمل المعتاد: مراجعة → نشر → استيعاب.',
      name: 'اسم المستودع',
      namePh: 'مثال: حزمة سياسات',
      domain: 'المجال الموضوعي',
      strategy: 'استراتيجية التصنيف',
      stratHeuristics: 'الاستدلال (سريع، بدون LLM)',
      stratLlm: 'تصنيف LLM',
      stratHybrid: 'هجين',
      files: 'المستندات المحددة',
      servingBadge: 'يخدم RAG الحر',
      ...
      go: 'استيراد',
      dupRepo: 'اسم المستودع موجود بالفعل — اختر اسمًا آخر.',
      failed: 'تعذر بدء الاستيراد. تحقق من المستندات وحاول مرة أخرى.'
    },
    editor: {
      addConcept: {
      ...
      concepts: {
        ...
        sourceLabel: 'المستند المصدر',
        sourceView: 'افتح المستند المصدر',
    ...
    docs: {
      ...
      gate: {
        ...
        servingWarn: '{n} من المستندات المحددة لا تزال تخدم النص الحر — لا يمكن استيعاب المستودع الجديد حتى يتم سحبها.'
      },
      produce: {
    ...
    pii: {
      ...
      type: {
        PERSON: 'اسم الشخص',
        LOCATION: 'الموقع',
        DATE_TIME: 'التاريخ أو الوقت',
        EMAIL_ADDRESS: 'عنوان البريد الإلكتروني',
        PHONE_NUMBER: 'رقم الهاتف',
        IP_ADDRESS: 'عنوان IP',
        NRP: 'رقم التسجيل الوطني',
        BD_NATIONAL_ID: 'رقم الهوية الوطنية'
      },
      desc: {
        PERSON: 'تم اكتشاف اسم شخص. الأسماء يمكن أن تحدد هوية شخص طبيعي بشكل مباشر.',
        LOCATION: 'تم اكتشاف اسم مكان. مع بيانات أخرى، يمكن أن يحدد هوية شخص.',
        DATE_TIME: 'تم اكتشاف تاريخ أو وقت. التواريخ قد تساهم في تحديد هوية شخص.',
        EMAIL_ADDRESS: 'تم اكتشاف عنوان بريد إلكتروني. إنه يحدد مباشرة هوية شخص يمكن التواصل معه.',
        PHONE_NUMBER: 'تم اكتشاف رقم هاتف. إنه يحدد مباشرة هوية شخص يمكن التواصل معه.',
        IP_ADDRESS: 'تم اكتشاف عنوان IP. يمكنه تحديد جهاز أو أسرة.',
        NRP: 'تم اكتشاف رقم تسجيل وطني. إنه يحدد هوية شخص بشكل قوي.',
      ...
      action: {
        ...
        remove: 'إزالة',
        accept: 'قبول',
        replacement: 'نص الاستبدال',
        apply: 'تطبيق',
        cancel: 'إلغاء'
      },
      resolved: {
        title: 'تمت معالجته في هذا الملف',
        redacted: 'تم التنقيح',
