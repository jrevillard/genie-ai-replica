...
window.APP_CONFIG = {
  ...
  mapboxToken: "${VUE_APP_MAPBOX_TOKEN:-}",
  defaultLocation: "${VUE_APP_DEFAULT_LOCATION:-Dhaka}",
  defaultLat: "${VUE_APP_DEFAULT_LAT:-23.8103}",
  defaultLon: "${VUE_APP_DEFAULT_LON:-90.4125}",
  keycloak: {
    url: "${KEYCLOAK_URL}",
