...
<template>
  <button
    type="button"
    :disabled="disabled"
    class="group flex w-full items-start gap-3 rounded-2xl border border-neutral-200 bg-white p-4 text-left shadow-sm transition hover:border-ieee-200 disabled:cursor-not-allowed disabled:opacity-60"
    :class="{
  ...
  >
    <span
      ...
      :class="modelValue === value ? 'border-ieee-700 bg-ieee-700' : 'border-slate-300 bg-white'"
    >
