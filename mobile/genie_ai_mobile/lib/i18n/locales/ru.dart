...
const Map<String, dynamic> ruLocale = {
  ...
  "about": {
    ...
    "version": "Версия",
    "description":
        "AgroGenio — ваш интеллектуальный помощник по сельскохозяйственной информации в Сальвадоре: здоровье посевов, оповещения о вредителях и рыночные цены, на вашем языке.",
