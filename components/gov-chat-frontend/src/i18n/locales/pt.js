...
export default {
  ...
  admin: {
    ...
    tools: {
      ...
      navFeeds: 'Fontes RSS',
      navWebSearch: 'Pesquisa na web (SearXNG)',
      backToAdmin: 'Voltar à administração',
      pageTitle: 'Gestão de ferramentas',
      feedsCardTitle: 'Fontes do ingestor de fluxos RSS',
      addFeed: '+ Adicionar fonte',
      loadingFeeds: 'A carregar fontes...',
      tableFeedTitle: 'Título da fonte',
      tableUrl: 'URL',
      tableInterval: 'Intervalo (s)',
      tableStatus: 'Estado',
      tableFailures: 'Falhas',
      tableActions: 'Ações',
      noFeeds: 'Nenhuma fonte configurada.',
      statusActive: 'Ativa',
      statusDisabled: 'Desativada',
      searxngCardTitle: 'Integração de pesquisa na web SearXNG',
      searxngDescription:
        'O SearXNG está integrado nativamente através do serviço de pesquisa do backend. Configure os parâmetros de pesquisa para testar a conectividade.',
      testSearchQuery: 'Consulta de teste',
      searchPlaceholder: 'Introduza a consulta...',
      searching: 'A pesquisar...',
      testSearch: 'Testar pesquisa',
      results: 'Resultados',
      tableTitle: 'Título',
      tableEngine: 'Motor',
      editFeedTitle: 'Editar fonte',
      addFeedTitle: 'Adicionar nova fonte',
      formTitle: 'Título',
      formRssUrl: 'URL RSS',
      formInterval: 'Intervalo de consulta (segundos)',
      formEnabled: 'Ativada',
      cancel: 'Cancelar',
      saveFeed: 'Guardar fonte',
      deleteConfirm: 'Tem a certeza de que pretende eliminar esta fonte?',
      titlePlaceholder: 'ex.: Notícias da ONU',
      navConfig: 'Configuração',
      configTitle: 'Configuração de ferramentas',
      loadingConfig: 'A carregar configuração...',
      webSearchEnabled: 'Pesquisa na web ativada',
      webSearchHint: 'Surte efeito na próxima consulta — sem necessidade de reimplementação.',
      whitelistTitle: 'Lista de permissões de domínios (um por linha)',
      whitelistPlaceholder: 'who.int\nun.org',
      whitelistHint: 'Um domínio permitido cobre todos os seus subdomínios. Vazio = sem filtragem.',
      whitelistInvalid: 'Domínio inválido: {d}',
      saving: 'A guardar...',
      save: 'Guardar',
      navAudit: 'Registro de auditoria',
      auditTitle: 'Registro de auditoria de invocações',
      auditExportCsv: 'Exportar CSV',
      auditExportJson: 'Exportar JSON',
      auditFilterTool: 'ID da ferramenta',
      auditFilterAction: 'Ação (invoke, block...)',
      auditFilterUser: 'ID do usuário',
      auditApply: 'Aplicar',
      auditLoading: 'Carregando entradas de auditoria...',
      auditColTime: 'Hora',
      auditColTool: 'Ferramenta',
      auditColAction: 'Ação',
      auditColDecision: 'Decisão',
      auditColDuration: 'Duração (ms)',
      auditColPii: 'PII encontrado',
      auditColUser: 'Usuário',
      auditEmpty: 'Ainda não há entradas de auditoria — aparecem quando a governança processar invocações.',
      auditMore: 'Carregar mais',
      navHealth: 'Estado',
      healthTitle: 'Resumo de estado',
      healthRefresh: 'Atualizar',
      healthLoading: 'A carregar resumo de estado...',
      healthTools: 'Ferramentas',
      healthFeeds: 'Fontes',
      healthColTool: 'Ferramenta',
      healthColCircuit: 'Circuito',
      healthColReachable: 'Acessível',
      healthColError: 'Erro',
      healthColFeed: 'Fonte',
      healthColStatus: 'Estado',
      healthColFailures: 'Falhas',
      healthColLastPoll: 'Última consulta',
      healthNoFeeds: 'Nenhuma fonte configurada.',
      healthYes: 'Sim',
      healthNo: 'Não'
    },
    huduma: 'Genie AI',
