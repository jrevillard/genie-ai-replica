...
class AnalyticsProxy {
  ...
  Future<int> getUniqueUsersCount(
    String startDate,
    String endDate, {
    String? locale,
  }) async {
    final res = await _api.get(
      'analytics/metric/uniqueUsers',
      params: {
        'startDate': startDate,
        'endDate': endDate,
  ...
  Future<Map<String, dynamic>> getComparisonData(
    ...
    final currentRes = await _api.get(
  ...
  Future<List<dynamic>> getTimeSeriesData(
    String type,
    String interval,
    String start,
    String end, {
  ...
  Future<List<dynamic>> getSatisfactionHeatmap(
    String period,
    String date, {
    String? locale,
  }) async {
  ...
  Future<Map<String, dynamic>> getSatisfactionGauge(
    String period,
    String date, {
    String? locale,
  }) async {
  ...
  Future<void> recordFeedback(
    ...
    await _api.post('analytics/feedback', {
      'queryId': queryId,
      'feedback': feedback,
    });
  }
