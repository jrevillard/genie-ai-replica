...
const Map<String, dynamic> esLocale = {
  ...
  "about": {
    ...
    "version": "Versión",
    "description":
        "AgroGenio es tu asistente inteligente para la información agrícola de El Salvador: salud de los cultivos, alertas de plagas y precios de mercado, en tu idioma.",
    "techStack": "Stack Tecnológico",
    "copyright": "Todos los derechos reservados.",
  },
  'welcomeMessage': '¡Bienvenido! ¿Cómo puedo asistirle hoy?',

  // Inteligencia agrícola (precios de mercado, salud de cultivos, plagas)
  "charts": {
    ...
    "noPestAlertsDesc":
        "No hay alertas de plagas para el nivel de gravedad seleccionado.",
    ...
    "assistanceHint": "P. ej., ¿Qué significa esta alerta para mis cultivos?",
    "assistanceInstructions":
        "Escriba su pregunta — la respuesta incluye las advertencias de datos mostradas en esta pantalla.",
    "assistancePrompt":
        "Necesito ayuda para interpretar estos datos agrícolas.",
    "close": "Cerrar",
    "copy": "Copiar",
    ...
    "getAssistance": "Obtener asistencia de IA",
    "gettingResponse": "Obteniendo respuesta...",
    "mapError": "Error del mapa",
    "noLocationData": "No hay datos de ubicación para este avistamiento",
  ...
  "market": {
    "unitQuintal": "Precios en dólares estadounidenses por quintal, la medida centroamericana de puerta de finca. 1 quintal = 46 kg; los datos fuente en USD/kg se convierten a 45,97 kg por quintal.",
    "unitPpi": "Índice de Precios al Productor de EE. UU. para la fabricación de pesticidas y productos químicos agrícolas (BLS). Los valores del índice son relativos a un período base, no precios absolutos — la tendencia muestra la dirección del costo, no un nivel de precio.",
    "unitIndex": "Los valores del índice son relativos a un período base (por ejemplo 2016 = 100), no precios absolutos — la tendencia muestra dirección y magnitud del cambio.",
    "unitPercent": "Último = la proporción de la cosecha alimentaria centroamericana, en masa, que se pierde entre la cosecha y la venta al por menor (estimación regional modelada FAO SDG 12.3.1 — no es un precio). Ejemplo: 8.3 significa que unos 8 de cada 100 kg de alimentos producidos nunca llegan al consumidor.",
    ...
    "localNewsHint": "P. ej., regulaciones locales, eventos climáticos...",
    "noData": "No hay datos disponibles",
    "noNewsItems": "No hay elementos recientes",
    "noResponse": "No se recibió respuesta",
    "period": "Periodo",
    ...
    "responseCopied": "Respuesta copiada al portapapeles",
    "selectTimeFrame": "Seleccione el plazo de predicción",
    "shareError": "Error al compartir",
    ...
    "trendDown": "A la baja",
    "trendStable": "Estable",
    "trendUnknown": "Desconocida",
    "worldNewsFactors": "Factores de noticias mundiales (opcional)",
    "worldNewsHint":
        "P. ej., problemas de cadenas de suministro globales, políticas comerciales...",
    "value": "Valor",
    "quality": "Calidad",
    "estimated": "Estimado",
    "actual": "Real",
