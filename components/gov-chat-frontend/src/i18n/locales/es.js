...
export default {
  ...
  admin: {
    ...
    tools: {
      ...
      navFeeds: 'Fuentes RSS',
      navWebSearch: 'Búsqueda web (SearXNG)',
      backToAdmin: 'Volver al panel de administración',
      pageTitle: 'Gestión de herramientas',
      feedsCardTitle: 'Fuentes del ingestor de flujos RSS',
      addFeed: '+ Añadir fuente',
      loadingFeeds: 'Cargando fuentes...',
      tableFeedTitle: 'Título de la fuente',
      tableUrl: 'URL',
      tableInterval: 'Intervalo (s)',
      tableStatus: 'Estado',
      tableFailures: 'Fallos',
      tableActions: 'Acciones',
      noFeeds: 'No hay fuentes configuradas.',
      statusActive: 'Activa',
      statusDisabled: 'Desactivada',
      searxngCardTitle: 'Integración de búsqueda web SearXNG',
      searxngDescription:
        'SearXNG está integrado de forma nativa mediante el servicio de búsqueda del backend. Configure los parámetros de búsqueda para probar la conectividad.',
      testSearchQuery: 'Consulta de prueba',
      searchPlaceholder: 'Introduzca la consulta...',
      searching: 'Buscando...',
      testSearch: 'Probar búsqueda',
      results: 'Resultados',
      tableTitle: 'Título',
      tableEngine: 'Motor',
      editFeedTitle: 'Editar fuente',
      addFeedTitle: 'Añadir nueva fuente',
      formTitle: 'Título',
      formRssUrl: 'URL RSS',
      formInterval: 'Intervalo de sondeo (segundos)',
      formEnabled: 'Activada',
      cancel: 'Cancelar',
      saveFeed: 'Guardar fuente',
      deleteConfirm: '¿Seguro que desea eliminar esta fuente?',
      titlePlaceholder: 'p. ej., Noticias de la ONU',
      navConfig: 'Configuración',
      configTitle: 'Configuración de herramientas',
      loadingConfig: 'Cargando configuración...',
      webSearchEnabled: 'Búsqueda web activada',
      webSearchHint: 'Surte efecto en la siguiente consulta; no requiere reimplementar.',
      whitelistTitle: 'Lista blanca de dominios (uno por línea)',
      whitelistPlaceholder: 'who.int\nun.org',
      whitelistHint: 'Un dominio autorizado cubre todos sus subdominios. Vacío = sin filtrado.',
      whitelistInvalid: 'Dominio no válido: {d}',
      saving: 'Guardando...',
      save: 'Guardar',
      navAudit: 'Registro de auditoría',
      auditTitle: 'Registro de auditoría de invocaciones',
      auditExportCsv: 'Exportar CSV',
      auditExportJson: 'Exportar JSON',
      auditFilterTool: 'ID de herramienta',
      auditFilterAction: 'Acción (invoke, block...)',
      auditFilterUser: 'ID de usuario',
      auditApply: 'Aplicar',
      auditLoading: 'Cargando entradas de auditoría...',
      auditColTime: 'Hora',
      auditColTool: 'Herramienta',
      auditColAction: 'Acción',
      auditColDecision: 'Decisión',
      auditColDuration: 'Duración (ms)',
      auditColPii: 'PII detectado',
      auditColUser: 'Usuario',
      auditEmpty: 'Aún no hay entradas de auditoría; aparecerán cuando la gobernanza procese invocaciones.',
      auditMore: 'Cargar más',
      navHealth: 'Estado',
      healthTitle: 'Resumen de estado',
      healthRefresh: 'Actualizar',
      healthLoading: 'Cargando resumen de estado...',
      healthTools: 'Herramientas',
      healthFeeds: 'Fuentes',
      healthColTool: 'Herramienta',
      healthColCircuit: 'Circuito',
      healthColReachable: 'Alcanzable',
      healthColError: 'Error',
      healthColFeed: 'Fuente',
      healthColStatus: 'Estado',
      healthColFailures: 'Fallos',
      healthColLastPoll: 'Última consulta',
      healthNoFeeds: 'No hay fuentes configuradas.',
      healthYes: 'Sí',
      healthNo: 'No'
    },
    huduma: 'Genie AI',
