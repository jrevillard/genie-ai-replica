...
struct FrLocale {
  ...
  "sidebar": [
    ...
    "noServices": "Aucun domaine de connaissance disponible",
    "noServiceResults": "Aucun domaine de connaissance trouvé pour \"{term}\"",
    "errorLoadingServices": "Impossible de charger les domaines de connaissance. Veuillez réessayer.",
