...
struct PtLocale {
  ...
  "sidebar": [
    ...
    "noServices": "Nenhuma área de conhecimento disponível",
    "noServiceResults": "Nenhuma área de conhecimento encontrada para \"{term}\"",
    "errorLoadingServices": "Falha ao carregar áreas de conhecimento. Por favor, tente novamente.",
