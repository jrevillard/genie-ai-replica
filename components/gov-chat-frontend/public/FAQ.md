...
MEWA is an advanced AI assistant that uses a technique called Retrieval-Augmented Generation (RAG). Instead of just relying on its pre-trained knowledge, it actively searches a specialized database of documents to find the most relevant, up-to-date information before answering your question. This ensures the answers are accurate and based on the latest data available in the system.

## **How can I get the most accurate answers?**

For the best results, provide as much specific context as possible.

* **Use the Service Tree:** Before asking a question, select the most relevant category or service from the tree on the left. This helps MEWA narrow its search to the correct set of documents.  
...
The "Related Documents" section shows you the exact source documents that MEWA used to formulate its answer. This is a key feature of the RAG system, providing transparency and allowing you to verify the information. You can click on any document to view the source material directly.

## **How does selecting a context help?**

When you select an item from the "Quick Help" or the service tree on the left, you are telling MEWA which specific set of documents to focus on. This significantly improves accuracy by preventing the AI from searching irrelevant information. For example, selecting "Taxation" ensures that your query is only answered using tax-related documents.
...
## **Can I trust the answers from MEWA?**

Yes. Because MEWA uses a RAG model, its answers are grounded in the specific documents listed in the "Related Documents" section. Unlike some AIs that can invent information, MEWA's responses are directly tied to its source material. You can always click on the source documents to verify the answer for yourself.
