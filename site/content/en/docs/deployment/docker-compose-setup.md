...
For external IdP integration (Google, Microsoft, etc.), see [External IdP Integration Guide](/docs/configuration/keycloak-admin-guide/).
...
- **Production deployment**: See [Docker Swarm Deployment Guide](/docs/deployment/docker-swarm-setup/) for multi-node, production-grade deployments with Ansible.
