...
struct DeLocale {
  ...
  "sidebar": [
    ...
    "noServices": "Keine Wissensbereiche verfügbar",
    "noServiceResults": "Keine Wissensbereiche gefunden für \"{term}\"",
    "errorLoadingServices": "Wissensbereiche konnten nicht geladen werden. Bitte versuchen Sie es erneut.",
