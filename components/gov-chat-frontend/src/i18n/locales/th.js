...
export default {
  ...
  admin: {
    ...
    tools: {
      ...
      navigation: 'การนำทาง',
      navFeeds: 'ฟีด RSS',
      navWebSearch: 'ค้นหาเว็บ (SearXNG)',
      backToAdmin: 'กลับไปหน้าผู้ดูแล',
      pageTitle: 'การจัดการเครื่องมือ',
      feedsCardTitle: 'ฟีดของตัวนำเข้าสตรีม RSS',
      addFeed: '+ เพิ่มฟีด',
      loadingFeeds: 'กำลังโหลดฟีด...',
      tableFeedTitle: 'ชื่อฟีด',
      tableUrl: 'URL',
      tableInterval: 'ช่วงเวลา (วินาที)',
      tableStatus: 'สถานะ',
      tableFailures: 'ความล้มเหลว',
      tableActions: 'การดำเนินการ',
      noFeeds: 'ยังไม่ได้กำหนดค่าฟีด',
      statusActive: 'ใช้งาน',
      statusDisabled: 'ปิดใช้งาน',
      searxngCardTitle: 'การเชื่อมต่อค้นหาเว็บ SearXNG',
      searxngDescription:
        'SearXNG ถูกผสานรวมโดยตรงผ่านบริการค้นหาของแบ็กเอนด์ กำหนดค่าพารามิเตอร์การค้นหาเพื่อทดสอบการเชื่อมต่อ',
      testSearchQuery: 'คำค้นหาทดสอบ',
      searchPlaceholder: 'ป้อนคำค้นหา...',
      searching: 'กำลังค้นหา...',
      testSearch: 'ทดสอบการค้นหา',
      results: 'ผลลัพธ์',
      tableTitle: 'ชื่อเรื่อง',
      tableEngine: 'เครื่องมือค้นหา',
      editFeedTitle: 'แก้ไขฟีด',
      addFeedTitle: 'เพิ่มฟีดใหม่',
      formTitle: 'ชื่อเรื่อง',
      formRssUrl: 'URL ของ RSS',
      formInterval: 'ช่วงเวลาดึงข้อมูล (วินาที)',
      formEnabled: 'เปิดใช้งาน',
      cancel: 'ยกเลิก',
      saveFeed: 'บันทึกฟีด',
      deleteConfirm: 'แน่ใจหรือไม่ว่าต้องการลบฟีดนี้?',
      titlePlaceholder: 'เช่น ข่าวสหประชาชาติ',
      navConfig: 'การตั้งค่า',
      configTitle: 'การตั้งค่าเครื่องมือ',
      loadingConfig: 'กำลังโหลดการตั้งค่า...',
      webSearchEnabled: 'เปิดใช้งานค้นหาเว็บ',
      webSearchHint: 'มีผลกับคำค้นถัดไป ไม่ต้อง deploy ใหม่',
      whitelistTitle: 'รายการโดเมนที่อนุญาต (บรรทัดละหนึ่งรายการ)',
      whitelistPlaceholder: 'who.int\nun.org',
      whitelistHint: 'โดเมนที่อนุญาตครอบคลุมโดเมนย่อยทั้งหมด ว่าง = ไม่กรอง',
      whitelistInvalid: 'โดเมนไม่ถูกต้อง: {d}',
      saving: 'กำลังบันทึก...',
      save: 'บันทึก',
      navAudit: 'บันทึกตรวจสอบ',
      auditTitle: 'บันทึกการตรวจสอบการเรียกใช้เครื่องมือ',
      auditExportCsv: 'ส่งออก CSV',
      auditExportJson: 'ส่งออก JSON',
      auditFilterTool: 'รหัสเครื่องมือ',
      auditFilterAction: 'การกระทำ (invoke, block...)',
      auditFilterUser: 'รหัสผู้ใช้',
      auditApply: 'ใช้',
      auditLoading: 'กำลังโหลดรายการตรวจสอบ...',
      auditColTime: 'เวลา',
      auditColTool: 'เครื่องมือ',
      auditColAction: 'การกระทำ',
      auditColDecision: 'การตัดสิน',
      auditColDuration: 'ระยะเวลา (มิลลิวินาที)',
      auditColPii: 'PII ที่พบ',
      auditColUser: 'ผู้ใช้',
      auditEmpty: 'ยังไม่มีรายการตรวจสอบ — จะปรากฏเมื่อธรรมาภิบาลเริ่มประมวลผลการเรียกใช้',
      auditMore: 'โหลดเพิ่มเติม',
      navHealth: 'สุขภาพ',
      healthTitle: 'ภาพรวมสุขภาพ',
      healthRefresh: 'รีเฟรช',
      healthLoading: 'กำลังโหลดภาพรวมสุขภาพ...',
      healthTools: 'เครื่องมือ',
      healthFeeds: 'ฟีด',
      healthColTool: 'เครื่องมือ',
      healthColCircuit: 'เซอร์กิต',
      healthColReachable: 'เข้าถึงได้',
      healthColError: 'ข้อผิดพลาด',
      healthColFeed: 'ฟีด',
      healthColStatus: 'สถานะ',
      healthColFailures: 'ความล้มเหลว',
      healthColLastPoll: 'สำรวจล่าสุด',
      healthNoFeeds: 'ยังไม่ได้กำหนดค่าฟีด',
      healthYes: 'ใช่',
      healthNo: 'ไม่'
    },
    huduma: 'Genie AI',
