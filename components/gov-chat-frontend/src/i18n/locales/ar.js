...
export default {
  ...
  quickhelp: {
    ...
    applyForIDPrompt:
      'أحتاج إلى معلومات حول كيفية تقديم طلب للحصول على بطاقة الهوية الوطنية',

    payTaxesPrompt:
      'ما هو العملية لدفع الضرائب عبر الإنترنت؟',

    startBusinessPrompt:
      'دلني على الخطوات لتسجيل عمل جديد',

    findHealthcarePrompt:
      'أين يمكنني العثور على معلومات حول خدمات الرعاية الصحية العامة؟',

    educationServicesPrompt:
      'ما هي خدمات التعليم المتاحة لأطفالي؟',

    transportLicensesPrompt:
      'كيف أجدد رخصة القيادة الخاصة بي؟',

    housingProgramsPrompt:
      'أخبرني عن برامج الإسكان الميسورة التكلفة في كينيا',

    findJobsPrompt:
      'ما هي فرص العمل الحكومية المتاحة حاليًا؟',

    justChatPrompt:
      'أود الدردشة حول الخدمات الحكومية'
  },
  common: {
    cancel: 'إلغاء',
    create: 'إنشاء',
