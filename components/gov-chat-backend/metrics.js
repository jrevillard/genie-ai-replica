 ...
 * Raw string literals at the call site MUST be rejected in
 ...
 *
 * No shared `recordLogDropped(reason)` helper crosses the
 * `shared/lib → backend` require boundary; this enum is the canonical
