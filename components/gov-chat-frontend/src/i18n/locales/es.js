...
export default {
  ...
  verification: {
    ...
    accountVerified: 'Su cuenta ha sido verificada con éxito. Ahora puede iniciar sesión en su cuenta.',
    invalidLink: 'El enlace de verificación es inválido o ha expirado.',
    missingToken: 'Falta el token de verificación.',
    generalError: 'Ocurrió un error durante la verificación. Por favor, intente nuevamente más tarde.',
  ...
  admin: {
    ...
    userEdit: {
      ...
      cannotDisableSelf: 'No puede deshabilitar su propia cuenta',
      accountRole: 'Rol de Cuenta',
      adminRole: 'Rol de Administrador',
      cannotChangeOwnRole: 'No puede cambiar su propio rol',
      ...
      failedToLoad: 'Falló la carga de datos del usuario',
      errorLoading: 'Error cargando datos del usuario',
      saveSuccess: 'Configuraciones de usuario actualizadas con éxito',
      errorSaving: 'Error guardando configuraciones de usuario',
      verifyEmailSuccess: 'Correo de verificación enviado con éxito',
      emailVerificationFailed: 'Falló el envío de correo de verificación',
      errorVerifyingEmail: 'Error enviando correo de verificación',
      passwordResetSent: 'Correo de restablecimiento de contraseña enviado',
      passwordResetFailed: 'Falló el envío de restablecimiento de contraseña',
  ...
  passwordResetConfirm: {
    ...
    tokenPlaceholder: 'Ingrese el token de restablecimiento',
    validateButton: 'Validar Token',
    newPasswordLabel: 'Nueva Contraseña',
    newPasswordPlaceholder: 'Cree una nueva contraseña',
    ...
    backToLogin: 'Volver a Iniciar Sesión',
    supportMessage: '¿Necesita ayuda? Contacte a nuestro equipo de soporte',
    passwordRequirements: 'La contraseña debe tener al menos 8 caracteres con al menos 1 número, 1 letra mayúscula y 1 carácter especial',
    passwordsDoNotMatch: 'Las contraseñas no coinciden',
    resetSuccess: 'Su contraseña ha sido restablecida con éxito',
    resetFailed: 'No se pudo restablecer la contraseña. Por favor, intente nuevamente.',
    noTokenProvided: 'Por favor, proporcione un token de restablecimiento',
    expiredToken: 'Este token de restablecimiento ha expirado. Por favor, solicite uno nuevo.',
    invalidToken: 'Token de restablecimiento inválido o no reconocido',
    ...
    passwordSuggestions: {
      atLeast8Chars: 'Use al menos 8 caracteres',
      addUppercase: 'Agregue letras mayúsculas',
      addLowercase: 'Agregue letras minúsculas',
      addNumbers: 'Agregue números',
      addSpecialChars: 'Agregue caracteres especiales'
    }
  },
  passwordReset: {
    appTitle: 'Genie AI',
    ...
    resetRequestSuccess: 'El enlace de restablecimiento de contraseña ha sido enviado a su correo electrónico',
    resetRequestFailed: 'No se pudo enviar el enlace de restablecimiento de contraseña. Por favor, intente nuevamente.',
    checkEmail: 'Por favor, revise su correo electrónico para obtener más instrucciones.'
  },
  register: {
    appTitle: "Genie AI",
    createAccount: "Crear Nueva Cuenta",
    username: "Nombre de Usuario",
    usernamePlaceholder: "Ingrese un nombre de usuario",
    email: "Correo Electrónico",
    emailPlaceholder: "Ingrese su correo electrónico",
    password: "Contraseña",
    ...
    loginNow: "Inicie sesión",
    privacyNotice: "Al registrarse, acepta nuestros Términos de Servicio y Política de Privacidad",
    usernameMinLength: "El nombre de usuario debe tener al menos 3 caracteres",
    invalidEmail: "Por favor, ingrese una dirección de correo electrónico válida",
    passwordRequirements: "La contraseña debe tener al menos 8 caracteres con al menos 1 número y 1 letra mayúscula",
    passwordsDoNotMatch: "Las contraseñas no coinciden",
    mustAcceptTerms: "Debe aceptar los Términos de Servicio",
    ...
    verificationEmailSent: "Se ha enviado un correo de verificación a {email}",
    checkEmailInstructions: "Por favor, revise su correo electrónico y siga las instrucciones para verificar su cuenta antes de iniciar sesión.",
    backToLogin: "Volver a Iniciar Sesión",
    noEmailReceived: "¿No recibió un correo electrónico?",
    resendVerification: "Reenviar correo de verificación",
    verificationResent: "Correo de verificación reenviado",
    verificationResendFailed: "Falló el reenvío del correo de verificación. Por favor, intente nuevamente.",
    usernameInvalidChars: 'El nombre de usuario solo puede contener letras, números, guiones bajos, puntos y guiones',
  ...
  login: {
    ...
    termsAndPolicy: 'Al iniciar sesión, acepta nuestros Términos de Servicio y Política de Privacidad',
    loggingIn: "Iniciando sesión...",
    fieldsRequired: "Nombre de usuario y contraseña son requeridos",
    invalidCredentials: "Nombre de usuario o contraseña inválidos",
    tooManyAttempts: "Demasiados intentos de inicio de sesión. Por favor, intente nuevamente más tarde.",
    loginFailed: "Inicio de sesión fallido. Por favor, intente nuevamente.",
  ...
  settings: {
    ...
    deleteAccountDesc: 'Esto eliminará permanentemente su cuenta y todos los datos asociados.',
    edit: 'Editar',
    ...
    accountDeletionWarning: 'Advertencia: Esta acción es permanente y no se puede deshacer. Todos sus datos serán eliminados permanentemente.',
    deletionReason: 'Motivo de eliminación (opcional):',
    deletionReasonPlaceholder: '¿Qué le hizo decidir eliminar su cuenta?',
    enterPasswordConfirm: 'Ingrese su contraseña para confirmar:',
    currentPasswordPlaceholder: 'Su contraseña actual',
    deleting: 'Eliminando...',
    permanentlyDeleteAccount: 'Eliminar Cuenta',
    accountDeletedSuccess: 'Su cuenta ha sido eliminada con éxito.',
    incorrectPassword: 'Contraseña incorrecta',
    accountDeletionFailed: 'Falló la eliminación de la cuenta. Por favor, intente nuevamente más tarde.',
    ...
    changingEmailTo: 'Cambiando su correo electrónico a',
    will: 'lo hará',
    logOutSystem: 'Cerrar sesión en el sistema',
    sendVerificationLink: 'Enviar un enlace de verificación a su nuevo correo electrónico',
    requireVerification: 'Requerir verificación antes de poder iniciar sesión nuevamente',
    checkNewEmailVerification: 'Por favor, revise su nuevo correo electrónico para obtener instrucciones de verificación.',
    unableToVerifyEmail: 'No se pudo verificar el correo electrónico. Por favor, intente nuevamente.',
    ...
    failedToUpdateEmail: 'Falló la actualización del correo electrónico. Por favor, intente nuevamente.',
    passwordResetInitiated: 'Se ha enviado un enlace de restablecimiento de contraseña a su dirección de correo electrónico.',
  ...
  userProfile: {
    ...
    instructions: {
      ...
      passwordHelp: 'La contraseña debe tener al menos 8 caracteres con una letra mayúscula, un número y un carácter especial',
