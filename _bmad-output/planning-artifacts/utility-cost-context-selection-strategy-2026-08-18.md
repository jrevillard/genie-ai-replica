...
status: adopted 2026-09-10 (steward decision — retrieval posture = option (d): curated spine + weighted entity layer + utility-cost union gate; operationalized by [ADR-okf-039](../../../docs/adr/okf-039-retrieval-mode-governance.md), Story 1.7, Story 10.7)
revision_note: >-
