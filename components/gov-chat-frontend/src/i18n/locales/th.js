...
export default {
  ...
  charts: {
    ...
    cropHealthTitle: 'สุขภาพพืชผล - ดัชนี NDVI',
    cropHealthSubtitle: 'สุขภาพพืชพรรณตามแผนก',
    averageNDVI: 'ค่าเฉลี่ย NDVI',
    improving: 'กำลังดีขึ้น',
    stable: 'คงที่',
    declining: 'ลดลง',
    overallHealth: 'สุขภาพโดยรวม',
    good: 'ดี',
    moderate: 'ปานกลาง',
    warning: 'คำเตือน',
    unknown: 'ไม่ทราบ',
    ...
    pestAlertTitle: 'การแจ้งเตือนศัตรูพืช',
    pestAlertSubtitle: 'คำเตือนศัตรูพืชและโรคปัจจุบัน',
    noPestAlerts: 'ไม่มีการแจ้งเตือนศัตรูพืชที่ใช้งานอยู่',
    noPestAlertsDesc: 'ไม่มีการแจ้งเตือนศัตรูพืชสำหรับระดับความรุนแรงที่เลือก',
    ...
    affectedCrops: 'พืชผลที่ได้รับผลกระทบ',
    areas: 'พื้นที่ที่ได้รับผลกระทบ',
    firstDetected: 'ตรวจพบครั้งแรก',
    viewMap: 'ดูบนแผนที่',
    share: 'แชร์',
    getAssistance: 'ขอความช่วยเหลือ',
    assistancePrompt: 'บริบทการแจ้งเตือนศัตรูพืชพร้อมแล้ว เพิ่มสถานการณ์เฉพาะของคุณ:',
    assistanceInstructions: 'เพิ่มบริบทเฉพาะของคุณด้านล่าง:',
    assistanceHint: 'ขนาดพืชผล การรักษาในปัจจุบัน คำถามเฉพาะ...',
    submitQuery: 'รับการตอบกลับจาก AI',
    aiResponse: 'การตอบกลับจาก AI',
    ...
    sharedVia: 'แชร์ผ่าน',
    details: 'รายละเอียด',
    pestAlerts: 'การแจ้งเตือนศัตรูพืช',
    noLocationData: 'ไม่มีข้อมูลตำแหน่งที่ตั้ง',
    mapError: 'ไม่สามารถเปิดแผนที่ได้',
    ...
    market: {
      ...
      livestock: 'ปศุสัตว์',
      fertilizer: 'ปุ๋ย',
      apiary: 'การเลี้ยงผึ้งและน้ำผึ้ง',
      aquaculture: 'การเพาะเลี้ยงสัตว์น้ำ',
      harvestStorage: 'เก็บเกี่ยวและจัดเก็บ',
      trendUp: 'เพิ่มขึ้น',
      trendDown: 'ลดลง',
      trendStable: 'คงที่',
      trendUnknown: 'ไม่ทราบ',
      latest: 'ล่าสุด',
      trend: 'แนวโน้ม',
      ...
      predictionFor: 'พยากรณ์สำหรับ',
      selectTimeFrame: 'เลือกช่วงเวลาพยากรณ์',
      timeFrame3Months: '3 เดือน',
      timeFrame6Months: '6 เดือน',
      timeFrame1Year: '1 ปี',
      timeFrame2Years: '2 ปี',
      worldNewsFactors: 'ปัจจัยข่าวโลก (ไม่บังคับ)',
      worldNewsHint: 'เช่น ปัญหาห่วงโซ่อุปทานโลก นโยบายการค้า ฯลฯ',
      localNewsFactors: 'ปัจจัยข่าวเอลซัลวาดอร์ (ไม่บังคับ)',
      localNewsHint: 'เช่น กฎระเบียบท้องถิ่น เหตุการณ์สภาพอากาศ นโยบาย ฯลฯ',
      analyzing: 'กำลังวิเคราะห์ข้อมูลตลาด...',
      error: 'ข้อผิดพลาด',
      predictionsFor: 'การพยากรณ์จาก AI',
      noResponse: 'ไม่ได้รับการตอบกลับ',
      errorOccurred: 'เกิดข้อผิดพลาด',
      responseCopied: 'คัดลอกการตอบกลับไปยังคลิปบอร์ดแล้ว',
      copy: 'คัดลอก',
      close: 'ปิด',
      share: 'แชร์',
      shareViaEmail: 'อีเมล',
      sharedVia: 'แชร์ผ่าน AgroGenio AI',
      shareError: 'เกิดข้อผิดพลาดในการแชร์'
    },
    tooltip: {
      title: 'วันที่',
