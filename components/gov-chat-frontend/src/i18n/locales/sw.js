...
export default {
  ...
  admin: {
    ...
    tools: {
      ...
      navFeeds: 'Vyanzo vya RSS',
      navWebSearch: 'Utafutaji wa wavuti (SearXNG)',
      backToAdmin: 'Rudi kwenye Admin',
      pageTitle: 'Usimamizi wa zana',
      feedsCardTitle: 'Vyanzo vya kuingiza mitiririko ya RSS',
      addFeed: '+ Ongeza chanzo',
      loadingFeeds: 'Inapakia vyanzo...',
      tableFeedTitle: 'Kichwa cha chanzo',
      tableUrl: 'URL',
      tableInterval: 'Muda (sek)',
      tableStatus: 'Hali',
      tableFailures: 'Kushindwa',
      tableActions: 'Vitendo',
      noFeeds: 'Hakuna vyanzo vilivyowekwa.',
      statusActive: 'Hai',
      statusDisabled: 'Imezimwa',
      searxngCardTitle: 'Unganishaji wa utafutaji wa wavuti wa SearXNG',
      searxngDescription:
        'SearXNG imeunganishwa asilia kupitia huduma ya utafutaji ya backend. Sanidi vigezo vya utafutaji ili kujaribu muunganisho.',
      testSearchQuery: 'Swali la majaribio',
      searchPlaceholder: 'Weka swali...',
      searching: 'Inatafuta...',
      testSearch: 'Jaribu utafutaji',
      results: 'Matokeo',
      tableTitle: 'Kichwa',
      tableEngine: 'Injini',
      editFeedTitle: 'Hariri chanzo',
      addFeedTitle: 'Ongeza chanzo kipya',
      formTitle: 'Kichwa',
      formRssUrl: 'URL ya RSS',
      formInterval: 'Muda wa kuuliza (sekunde)',
      formEnabled: 'Imewashwa',
      cancel: 'Ghairi',
      saveFeed: 'Hifadhi chanzo',
      deleteConfirm: 'Una uhakika unataka kufuta chanzo hiki?',
      titlePlaceholder: 'k.m. Habari za UN',
      navConfig: 'Usanidi',
      configTitle: 'Usanidi wa zana',
      loadingConfig: 'Inapakia usanidi...',
      webSearchEnabled: 'Utafutaji wa wavuti umewashwa',
      webSearchHint: 'Hufanya kazi katika swali lijalo — bila kusakinisha upya.',
      whitelistTitle: 'Orodha ya kikoa ruhusiwa (mmoja kwa mstari)',
      whitelistPlaceholder: 'who.int\nun.org',
      whitelistHint: 'Kikoa kilichoruhusiwa kinashughulikia subdomains zake zote. Tupu = hakuna kuchuja.',
      whitelistInvalid: 'Kikoa batili: {d}',
      saving: 'Inahifadhi...',
      save: 'Hifadhi',
      navAudit: 'Kumbukumbu za ukaguzi',
      auditTitle: 'Kumbukumbu za ukaguzi wa simu za zana',
      auditExportCsv: 'Hamisha CSV',
      auditExportJson: 'Hamisha JSON',
      auditFilterTool: 'Kitambulisho cha zana',
      auditFilterAction: 'Kitendo (invoke, block...)',
      auditFilterUser: 'Kitambulisho cha mtumiaji',
      auditApply: 'Tekeleza',
      auditLoading: 'Inapakia kumbukumbu za ukaguzi...',
      auditColTime: 'Wakati',
      auditColTool: 'Zana',
      auditColAction: 'Kitendo',
      auditColDecision: 'Uamuzi',
      auditColDuration: 'Muda (ms)',
      auditColPii: 'PII iliyopatikana',
      auditColUser: 'Mtumiaji',
      auditEmpty: 'Hakuna kumbukumbu za ukaguzi kwa sasa — zitaonekana mara utawala unapoanza kusimamia simu.',
      auditMore: 'Pakia zaidi',
      navHealth: 'Afya',
      healthTitle: 'Muhtasari wa afya',
      healthRefresh: 'Onyesha upya',
      healthLoading: 'Inapakia muhtasari wa afya...',
      healthTools: 'Zana',
      healthFeeds: 'Vyanzo',
      healthColTool: 'Zana',
      healthColCircuit: 'Kizui',
      healthColReachable: 'Inafikiwa',
      healthColError: 'Hitilafu',
      healthColFeed: 'Chanzo',
      healthColStatus: 'Hali',
      healthColFailures: 'Kushindwa',
      healthColLastPoll: 'Utafutaji wa mwisho',
      healthNoFeeds: 'Hakuna vyanzo vilivyowekwa.',
      healthYes: 'Ndiyo',
      healthNo: 'Hapana'
    },
    huduma: 'Genie AI',
