...
export default {
  ...
  charts: {
    ...
    cropHealthTitle: 'صحة المحاصيل - مؤشر NDVI',
    cropHealthSubtitle: 'صحة الغطاء النباتي حسب الإدارات',
    averageNDVI: 'متوسط NDVI',
    improving: 'يتحسن',
    stable: 'مستقر',
    declining: 'يتدهور',
    ...
    pestAlertTitle: 'تنبيهات الآفات',
    pestAlertSubtitle: 'تحذيرات حالية عن الآفات والأمراض',
    noPestAlerts: 'لا توجد تنبيهات نشطة للآفات',
    noPestAlertsDesc: 'لا توجد تنبيهات للآفات لمستوى الخطورة المحدد.',
    ...
    affectedCrops: 'المحاصيل المتضررة',
    areas: 'المناطق المتضررة',
    firstDetected: 'اكتشف لأول مرة',
    viewMap: 'عرض على الخريطة',
    share: 'مشاركة',
    getAssistance: 'الحصول على مساعدة',
    assistancePrompt: 'سياق تنبيه الآفة جاهز. أضف حالتك المحددة:',
    assistanceInstructions: 'أضف سياقك المحدد أدناه:',
    assistanceHint: 'حجم المحصول، العلاج الحالي، أسئلة محددة...',
    submitQuery: 'الحصول على رد الذكاء الاصطناعي',
    ...
    market: {
      ...
      fertilizer: 'سماد',
      apiary: 'منحل وعسل',
      aquaculture: 'الاستزراع السمكي',
      harvestStorage: 'الحصاد والتخزين',
      trendUp: 'ارتفاع',
      trendDown: 'انخفاض',
      trendStable: 'مستقر',
      trendUnknown: 'غير معروف',
      latest: 'الأحدث',
      trend: 'الاتجاه',
      ...
      predictionFor: 'تنبؤ لـ',
      selectTimeFrame: 'اختر الإطار الزمني للتنبؤ',
      timeFrame3Months: '3 أشهر',
      timeFrame6Months: '6 أشهر',
      timeFrame1Year: 'سنة واحدة',
      timeFrame2Years: 'سنتان',
      worldNewsFactors: 'عوامل الأخبار العالمية (اختياري)',
      worldNewsHint: 'مثلاً، مشاكل سلاسل التوريد العالمية، سياسات التجارة، إلخ.',
      localNewsFactors: 'عوامل أخبار السلفادور (اختياري)',
      localNewsHint: 'مثلاً، اللوائح المحلية، الأحداث الجوية، السياسات، إلخ.',
      analyzing: 'تحليل بيانات السوق...',
      error: 'خطأ',
      predictionsFor: 'تنبؤات الذكاء الاصطناعي',
      ...
      close: 'إغلاق',
      share: 'مشاركة',
      shareViaEmail: 'بريد إلكتروني',
      sharedVia: 'تمت المشاركة عبر AgroGenio AI',
      shareError: 'خطأ في المشاركة'
    },
    tooltip: {
      title: 'التاريخ',
