...
class ChatTemplate:
    ...
    """
                ...
                template = """
    ### You are a helpful, respectful and honest assistant helping users discover and understand public services in Kenya. \
    Use only relevant details from the provided search results.  \
